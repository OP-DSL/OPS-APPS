...
//
    ...
    void buildOpenCLKernels_multidim_copy_kernel(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1) {
      ...
      if(!isbuilt_multidim_copy_kernel) {
        ...
        instance->ostream() <<"Compiling multidim_copy_kernel "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_multidim_copy_kernel=%d  -Dydim0_multidim_copy_kernel=%d  -Dxdim1_multidim_copy_kernel=%d  -Dydim1_multidim_copy_kernel=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1);
            else
              sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_multidim_copy_kernel=%d  -Dydim0_multidim_copy_kernel=%d  -Dxdim1_multidim_copy_kernel=%d  -Dydim1_multidim_copy_kernel=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1);
          else {
