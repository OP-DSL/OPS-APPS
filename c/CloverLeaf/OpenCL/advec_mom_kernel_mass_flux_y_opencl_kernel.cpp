...
//
    ...
    void buildOpenCLKernels_advec_mom_kernel_mass_flux_y(OPS_instance *instance, int xdim0, int xdim1) {
      ...
      if(!isbuilt_advec_mom_kernel_mass_flux_y) {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[77] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_advec_mom_kernel_mass_flux_y", &ret);
        clSafeCall( ret );
