...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    update_halo_kernel2_yvel_plus_2_a_gpu(argp0, argp1, arg2);
  }
...
void ops_par_loop_update_halo_kernel2_yvel_plus_2_a_execute(ops_kernel_descriptor *desc) {
  ...
  if (x_size > 0 && y_size > 0)
    hipLaunchKernelGGL(ops_update_halo_kernel2_yvel_plus_2_a,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],
