...
//
    ...
    static bool isbuilt_preproc_kernel = false;

    void buildOpenCLKernels_preproc_kernel(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3, int xdim4, int ydim4, int xdim5, int ydim5, int xdim6, int ydim6, int xdim7, int ydim7, int xdim8, int ydim8, int xdim9, int ydim9, int xdim10, int ydim10) {

      //int ocl_fma = OCL_FMA;
      if(!isbuilt_preproc_kernel) {
        buildOpenCLKernels(instance);
        //clSafeCall( clUnloadCompiler() );
        cl_int ret;
        char* source_filename[1] = {(char*)"./OpenCL/preproc_kernel.cl"};
        ...
        instance->ostream() <<"Compiling preproc_kernel "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_preproc_kernel=%d  -Dydim0_preproc_kernel=%d  -Dxdim1_preproc_kernel=%d  -Dydim1_preproc_kernel=%d  -Dxdim2_preproc_kernel=%d  -Dydim2_preproc_kernel=%d  -Dxdim3_preproc_kernel=%d  -Dydim3_preproc_kernel=%d  -Dxdim4_preproc_kernel=%d  -Dydim4_preproc_kernel=%d  -Dxdim5_preproc_kernel=%d  -Dydim5_preproc_kernel=%d  -Dxdim6_preproc_kernel=%d  -Dydim6_preproc_kernel=%d  -Dxdim7_preproc_kernel=%d  -Dydim7_preproc_kernel=%d  -Dxdim8_preproc_kernel=%d  -Dydim8_preproc_kernel=%d  -Dxdim9_preproc_kernel=%d  -Dydim9_preproc_kernel=%d  -Dxdim10_preproc_kernel=%d  -Dydim10_preproc_kernel=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1,xdim2,ydim2,xdim3,ydim3,xdim4,ydim4,xdim5,ydim5,xdim6,ydim6,xdim7,ydim7,xdim8,ydim8,xdim9,ydim9,xdim10,ydim10);
            else
          ...
          instance->ostream() << "compiling preproc_kernel -- done\n";

        // Create the OpenCL kernel
        instance->opencl_instance->OPS_opencl_core.kernel[1] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_preproc_kernel", &ret);
        clSafeCall( ret );

        isbuilt_preproc_kernel = true;
        free(source_str[0]);
      }
...
void ops_par_loop_preproc_kernel(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg9, ops_arg arg10, ops_arg arg11) {
  ...
  buildOpenCLKernels_preproc_kernel(block->instance,
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 11, sizeof(cl_int), (void*) &nx ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 12, sizeof(cl_int), (void*) &ny ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 13, sizeof(cl_int), (void*) &nz ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 14, sizeof(cl_double), (void*) &lambda ));
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 28, sizeof(cl_int), (void*) &arg_idx[2] ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 29, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 30, sizeof(cl_int), (void*) &y_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 31, sizeof(cl_int), (void*) &z_size ));
