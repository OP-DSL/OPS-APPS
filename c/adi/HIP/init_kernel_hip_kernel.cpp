...
void ops_par_loop_init_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_init_kernel_h[0][0] || ydim0 != dims_init_kernel_h[0][1]) {
    dims_init_kernel_h[0][0] = xdim0;
    dims_init_kernel_h[0][1] = ydim0;
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    hipLaunchKernelGGL(ops_init_kernel,grid ,tblock ,0 ,0 , (double *)p_a[0], arg_idx[0], arg_idx[1], arg_idx[2],x_size, y_size, z_size);
