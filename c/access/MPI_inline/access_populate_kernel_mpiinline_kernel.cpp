...
extern int xdim0_access_populate_kernel;
int xdim0_access_populate_kernel_h = -1;

#ifdef __cplusplus
extern "C" {
#endif
void access_populate_kernel_c_wrapper(
  double *p_a0,
  int *p_a1,
...
void ops_par_loop_access_populate_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  if (xdim0 != xdim0_access_populate_kernel_h) {
    xdim0_access_populate_kernel = xdim0;
    xdim0_access_populate_kernel_h = xdim0;
  }
  ...
  access_populate_kernel_c_wrapper(
    p_a0,
    p_a1,
    arg_idx[0], arg_idx[1],
    x_size, y_size);
