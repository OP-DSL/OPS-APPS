...
extern int xdim0_complex_numbers_block0_5_kernel;
int xdim0_complex_numbers_block0_5_kernel_h = -1;
...
void ops_par_loop_complex_numbers_block0_5_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  if (xdim0 != xdim0_complex_numbers_block0_5_kernel_h) {
    xdim0_complex_numbers_block0_5_kernel = xdim0;
    xdim0_complex_numbers_block0_5_kernel_h = xdim0;
  }
  ...
  complex_numbers_block0_5_kernel_c_wrapper(
    p_a0,
    p_a1,
    arg_idx[0],
    x_size);
