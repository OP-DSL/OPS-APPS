...
int size0 ){
  ...
  if (size0==-1) dims_complex_numbers_block0_cn_kernel[0][0]=0;
  ...
  for (int d=0; d<1; d++)
    ops_reduction_hip<OPS_INC>(&arg1[d+(hipBlockIdx_x + hipBlockIdx_y*hipBlockDim_x)*1],arg1_l[d]);
  for (int d=0; d<1; d++)
    ops_reduction_hip<OPS_INC>(&arg2[d+(hipBlockIdx_x + hipBlockIdx_y*hipBlockDim_x)*1],arg2_l[d]);
...
void ops_par_loop_complex_numbers_block0_cn_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_complex_numbers_block0_cn_kernel_h[0][0]) {
    ...
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_complex_numbers_block0_cn_kernel), dims_complex_numbers_block0_cn_kernel_h, sizeof(dims_complex_numbers_block0_cn_kernel)));
  }
  ...
  if (x_size > 0)
    hipLaunchKernelGGL(ops_complex_numbers_block0_cn_kernel,grid ,tblock ,nshared ,0 , (double *)p_a[0], (double *)arg1.data_d,
