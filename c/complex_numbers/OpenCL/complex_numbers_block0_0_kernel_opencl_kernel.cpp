...
//
    ...
    static bool isbuilt_complex_numbers_block0_0_kernel = false;

    void buildOpenCLKernels_complex_numbers_block0_0_kernel(OPS_instance *instance, int xdim0, int xdim1) {

      //int ocl_fma = OCL_FMA;
      if(!isbuilt_complex_numbers_block0_0_kernel) {
        buildOpenCLKernels(instance);
        //clSafeCall( clUnloadCompiler() );
        cl_int ret;
        char* source_filename[1] = {(char*)"./OpenCL/complex_numbers_block0_0_kernel.cl"};
        ...
        instance->ostream() <<"Compiling complex_numbers_block0_0_kernel "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_complex_numbers_block0_0_kernel=%d  -Dxdim1_complex_numbers_block0_0_kernel=%d ", pPath, 32,xdim0,xdim1);
            else
              sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_complex_numbers_block0_0_kernel=%d  -Dxdim1_complex_numbers_block0_0_kernel=%d ", pPath, 32,xdim0,xdim1);
          else {
          ...
          instance->ostream() << "compiling complex_numbers_block0_0_kernel -- done\n";

        // Create the OpenCL kernel
        instance->opencl_instance->OPS_opencl_core.kernel[2] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_complex_numbers_block0_0_kernel", &ret);
        clSafeCall( ret );

        isbuilt_complex_numbers_block0_0_kernel = true;
        free(source_str[0]);
      }
...
// host stub function
void ops_par_loop_complex_numbers_block0_0_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,2,"complex_numbers_block0_0_kernel");
  ...
  buildOpenCLKernels_complex_numbers_block0_0_kernel(block->instance,
  xdim0,xdim1);
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[2], 2, sizeof(cl_double), (void*) &rc0 ));
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[2], 5, sizeof(cl_double), (void*) &rc3 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[2], 6, sizeof(cl_double), (void*) &deltai0 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[2], 7, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[2], 8, sizeof(cl_int), (void*) &base1 ));
