...
//
    ...
    static bool isbuilt_complex_numbers_block0_cn_kernel = false;

    void buildOpenCLKernels_complex_numbers_block0_cn_kernel(OPS_instance *instance, int xdim0) {

      //int ocl_fma = OCL_FMA;
      if(!isbuilt_complex_numbers_block0_cn_kernel) {
        buildOpenCLKernels(instance);
        //clSafeCall( clUnloadCompiler() );
        cl_int ret;
        char* source_filename[1] = {(char*)"./OpenCL/complex_numbers_block0_cn_kernel.cl"};
        ...
        instance->ostream() <<"Compiling complex_numbers_block0_cn_kernel "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_complex_numbers_block0_cn_kernel=%d ", pPath, 32,xdim0);
            else
              sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_complex_numbers_block0_cn_kernel=%d ", pPath, 32,xdim0);
          else {
          ...
          instance->ostream() << "compiling complex_numbers_block0_cn_kernel -- done\n";

        // Create the OpenCL kernel
        instance->opencl_instance->OPS_opencl_core.kernel[6] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_complex_numbers_block0_cn_kernel", &ret);
        clSafeCall( ret );

        isbuilt_complex_numbers_block0_cn_kernel = true;
        free(source_str[0]);
      }
...
void ops_par_loop_complex_numbers_block0_cn_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  buildOpenCLKernels_complex_numbers_block0_cn_kernel(block->instance,
  xdim0);
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[6], 2, nthread*sizeof(double), NULL));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[6], 3, sizeof(cl_int), (void*) &r_bytes1 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[6], 4, sizeof(cl_mem), (void*) &arg2.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[6], 5, nthread*sizeof(double), NULL));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[6], 6, sizeof(cl_int), (void*) &r_bytes2 ));
