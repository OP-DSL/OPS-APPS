...
int size2 ){
  ...
  if (size0==-1) dims_multidim_kernel[0][0]=0;
  ...
  arg0 += idx_x * 1+ idx_y * 1* dims_multidim_kernel[0][0] + idx_z * 1 * dims_multidim_kernel[0][0] * dims_multidim_kernel[0][1];

  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ACC<double> argp0(3, dims_multidim_kernel[0][0], dims_multidim_kernel[0][1], dims_multidim_kernel[0][2], arg0);
...
void ops_par_loop_multidim_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_multidim_kernel_h[0][0] || ydim0 != dims_multidim_kernel_h[0][1] || zdim0 != dims_multidim_kernel_h[0][2]) {
    dims_multidim_kernel_h[0][0] = xdim0;
    dims_multidim_kernel_h[0][1] = ydim0;
    dims_multidim_kernel_h[0][2] = zdim0;
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_multidim_kernel), dims_multidim_kernel_h, sizeof(dims_multidim_kernel)));
  }
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    hipLaunchKernelGGL(ops_multidim_kernel,grid ,tblock ,0 ,0 , (double *)p_a[0], arg_idx[0], arg_idx[1], arg_idx[2],x_size, y_size, z_size);
