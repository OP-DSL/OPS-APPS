...
int size2 ){
  ...
  if (size0==-1) dims_multidim_copy_kernel[0][0]=0;
...
void ops_par_loop_multidim_copy_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_multidim_copy_kernel_h[0][0] || ydim0 != dims_multidim_copy_kernel_h[0][1] || zdim0 != dims_multidim_copy_kernel_h[0][2] || xdim1 != dims_multidim_copy_kernel_h[1][0] || ydim1 != dims_multidim_copy_kernel_h[1][1] || zdim1 != dims_multidim_copy_kernel_h[1][2]) {
    ...
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_multidim_copy_kernel), dims_multidim_copy_kernel_h, sizeof(dims_multidim_copy_kernel)));
  }
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    hipLaunchKernelGGL(ops_multidim_copy_kernel,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],x_size, y_size, z_size);
