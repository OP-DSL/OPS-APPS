...
int size2 ){
  ...
  for (int d=0; d<3; d++)
    ops_reduction_hip<OPS_INC>(&arg1[d+(hipBlockIdx_x + hipBlockIdx_y*hipGridDim_x + hipBlockIdx_z*hipGridDim_x*hipGridDim_y)*3],arg1_l[d]);
...
void ops_par_loop_multidim_reduce_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    hipLaunchKernelGGL(ops_multidim_reduce_kernel,grid ,tblock ,nshared ,0 , (double *)p_a[0], (double *)arg1.data_d,x_size, y_size, z_size);
