...
extern int xdim0_complex_populate_kernel;
int xdim0_complex_populate_kernel_h = -1;
...
void ops_par_loop_complex_populate_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  if (xdim0 != xdim0_complex_populate_kernel_h) {
    xdim0_complex_populate_kernel = xdim0;
    xdim0_complex_populate_kernel_h = xdim0;
  }
  ...
  complexd *p_a0 = (complexd *)(args[0].data + base0);

  #ifdef OPS_MPI
  complexd *p_a1 = (complexd *)(((ops_reduction)args[1].data)->data + ((ops_reduction)args[1].data)->size * block->index);
  #else
  complexd *p_a1 = (complexd *)(((ops_reduction)args[1].data)->data);
  #endif
  ...
  complex_populate_kernel_c_wrapper(
    p_a0,
    p_a1,
    p_a2,
    arg_idx[0], arg_idx[1],
