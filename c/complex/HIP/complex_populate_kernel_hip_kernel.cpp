...
int size1 ){
  ...
  if (size0==-1) dims_complex_populate_kernel[0][0]=0;
...
void ops_par_loop_complex_populate_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_complex_populate_kernel_h[0][0]) {
    ...
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_complex_populate_kernel), dims_complex_populate_kernel_h, sizeof(dims_complex_populate_kernel)));
  }
  ...
  if (x_size > 0 && y_size > 0)
    hipLaunchKernelGGL(ops_complex_populate_kernel,grid ,tblock ,nshared ,0 , (complexd *)p_a[0], (complexd *)arg1.data_d,
