...
//
    ...
    void buildOpenCLKernels_poisson_kernel_stencil(OPS_instance *instance, int xdim0, int xdim1) {
      ...
      if(!isbuilt_poisson_kernel_stencil) {
        ...
        instance->ostream() <<"Compiling poisson_kernel_stencil "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_poisson_kernel_stencil=%d  -Dxdim1_poisson_kernel_stencil=%d ", pPath, 32,xdim0,xdim1);
            else
              sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_poisson_kernel_stencil=%d  -Dxdim1_poisson_kernel_stencil=%d ", pPath, 32,xdim0,xdim1);
          else {
