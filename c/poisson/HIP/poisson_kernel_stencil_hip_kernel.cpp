...
void ops_par_loop_poisson_kernel_stencil_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_poisson_kernel_stencil_h[0][0] || xdim1 != dims_poisson_kernel_stencil_h[1][0]) {
  ...
  if (x_size > 0 && y_size > 0)
    hipLaunchKernelGGL(ops_poisson_kernel_stencil,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],x_size, y_size);
