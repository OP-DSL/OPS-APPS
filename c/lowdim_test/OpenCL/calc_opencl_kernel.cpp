...
//
    ...
    static bool isbuilt_calc = false;

    void buildOpenCLKernels_calc(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3, int xdim4, int ydim4, int xdim5, int ydim5, int xdim6, int ydim6) {
      ...
      if(!isbuilt_calc) {
        ...
        cl_int ret;
        char* source_filename[1] = {(char*)"./OpenCL/calc.cl"};
        ...
        instance->ostream() <<"Compiling calc "<<OCL_FMA<<" source -- start \n";
          ...
          instance->ostream() << "compiling calc -- done\n";

        // Create the OpenCL kernel
        instance->opencl_instance->OPS_opencl_core.kernel[7] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_calc", &ret);
        clSafeCall( ret );
...
void ops_par_loop_calc(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6) {
  ...
  buildOpenCLKernels_calc(block->instance,
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[7], 13, sizeof(cl_int), (void*) &base6 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[7], 14, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[7], 15, sizeof(cl_int), (void*) &y_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[7], 16, sizeof(cl_int), (void*) &z_size ));
