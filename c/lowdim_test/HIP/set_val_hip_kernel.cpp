...
void ops_par_loop_set_val_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_set_val_h[0][0] || ydim0 != dims_set_val_h[0][1]) {
    ...
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_set_val), dims_set_val_h, sizeof(dims_set_val)));
  }
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    hipLaunchKernelGGL(ops_set_val,grid ,tblock ,0 ,0 , (double *)p_a[0], *(double *)arg1.data,x_size, y_size, z_size);
