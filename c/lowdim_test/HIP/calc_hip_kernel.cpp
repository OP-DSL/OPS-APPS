...
int size2 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * dims_calc[0][0] + idx_z * 1*1 * dims_calc[0][0] * dims_calc[0][1];
  arg1 += idx_x * 1*1 + idx_y * 1*1 * dims_calc[1][0] + idx_z * 0*1 * dims_calc[1][0] * dims_calc[1][1];
  arg2 += idx_x * 0*1 + idx_y * 1*1 * dims_calc[2][0] + idx_z * 1*1 * dims_calc[2][0] * dims_calc[2][1];
  arg3 += idx_x * 1*1 + idx_y * 0*1 * dims_calc[3][0] + idx_z * 1*1 * dims_calc[3][0] * dims_calc[3][1];
  arg4 += idx_x * 1*1 + idx_y * 0*1 * dims_calc[4][0] + idx_z * 0*1 * dims_calc[4][0] * dims_calc[4][1];
  arg5 += idx_x * 0*1 + idx_y * 1*1 * dims_calc[5][0] + idx_z * 0*1 * dims_calc[5][0] * dims_calc[5][1];
...
void ops_par_loop_calc_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_calc_h[0][0] || ydim0 != dims_calc_h[0][1] || xdim1 != dims_calc_h[1][0] || ydim1 != dims_calc_h[1][1] || xdim2 != dims_calc_h[2][0] || ydim2 != dims_calc_h[2][1] || xdim3 != dims_calc_h[3][0] || ydim3 != dims_calc_h[3][1] || xdim4 != dims_calc_h[4][0] || ydim4 != dims_calc_h[4][1] || xdim5 != dims_calc_h[5][0] || ydim5 != dims_calc_h[5][1] || xdim6 != dims_calc_h[6][0] || ydim6 != dims_calc_h[6][1]) {
    dims_calc_h[0][0] = xdim0;
    dims_calc_h[0][1] = ydim0;
    dims_calc_h[1][0] = xdim1;
    dims_calc_h[1][1] = ydim1;
    dims_calc_h[2][0] = xdim2;
    dims_calc_h[2][1] = ydim2;
    dims_calc_h[3][0] = xdim3;
    dims_calc_h[3][1] = ydim3;
    dims_calc_h[4][0] = xdim4;
    dims_calc_h[4][1] = ydim4;
    dims_calc_h[5][0] = xdim5;
    dims_calc_h[5][1] = ydim5;
    dims_calc_h[6][0] = xdim6;
    dims_calc_h[6][1] = ydim6;
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_calc), dims_calc_h, sizeof(dims_calc)));
  }
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    hipLaunchKernelGGL(ops_calc,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],
