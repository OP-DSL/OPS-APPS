...
extern int xdim0_tea_leaf_cg_calc_w_reduce_kernel;
int xdim0_tea_leaf_cg_calc_w_reduce_kernel_h = -1;
extern int xdim1_tea_leaf_cg_calc_w_reduce_kernel;
int xdim1_tea_leaf_cg_calc_w_reduce_kernel_h = -1;
extern int xdim2_tea_leaf_cg_calc_w_reduce_kernel;
int xdim2_tea_leaf_cg_calc_w_reduce_kernel_h = -1;
extern int xdim3_tea_leaf_cg_calc_w_reduce_kernel;
...
void ops_par_loop_tea_leaf_cg_calc_w_reduce_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3, ops_arg arg4, ops_arg arg5, ops_arg arg6) {
  ...
  tea_leaf_cg_calc_w_reduce_kernel_c_wrapper(
    p_a0,
    p_a1,
    p_a2,
    p_a3,
