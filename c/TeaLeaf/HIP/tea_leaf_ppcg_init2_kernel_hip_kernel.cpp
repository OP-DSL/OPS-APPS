...
int size1 ){
  ...
  if (size0==-1) dims_tea_leaf_ppcg_init2_kernel[0][0]=0;
...
void ops_par_loop_tea_leaf_ppcg_init2_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_tea_leaf_ppcg_init2_kernel_h[0][0] || xdim1 != dims_tea_leaf_ppcg_init2_kernel_h[1][0] || xdim2 != dims_tea_leaf_ppcg_init2_kernel_h[2][0] || xdim3 != dims_tea_leaf_ppcg_init2_kernel_h[3][0]) {
    ...
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_tea_leaf_ppcg_init2_kernel), dims_tea_leaf_ppcg_init2_kernel_h, sizeof(dims_tea_leaf_ppcg_init2_kernel)));
  }
  ...
  if (x_size > 0 && y_size > 0)
    hipLaunchKernelGGL(ops_tea_leaf_ppcg_init2_kernel,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],
