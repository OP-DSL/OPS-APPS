...
int size1 ){
  ...
  if (size0==-1) dims_tea_leaf_cg_calc_ur_r_reduce_kernel[0][0]=0;
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * dims_tea_leaf_cg_calc_ur_r_reduce_kernel[0][0];
...
void ops_par_loop_tea_leaf_cg_calc_ur_r_reduce_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_tea_leaf_cg_calc_ur_r_reduce_kernel_h[0][0] || xdim1 != dims_tea_leaf_cg_calc_ur_r_reduce_kernel_h[1][0]) {
    dims_tea_leaf_cg_calc_ur_r_reduce_kernel_h[0][0] = xdim0;
    dims_tea_leaf_cg_calc_ur_r_reduce_kernel_h[1][0] = xdim1;
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_tea_leaf_cg_calc_ur_r_reduce_kernel), dims_tea_leaf_cg_calc_ur_r_reduce_kernel_h, sizeof(dims_tea_leaf_cg_calc_ur_r_reduce_kernel)));
  }
  ...
  if (x_size > 0 && y_size > 0)
    hipLaunchKernelGGL(ops_tea_leaf_cg_calc_ur_r_reduce_kernel,grid ,tblock ,nshared ,0 , (double *)p_a[0], (double *)p_a[1],
         *(double *)arg2.data, (double *)arg3.data_d,x_size, y_size);
