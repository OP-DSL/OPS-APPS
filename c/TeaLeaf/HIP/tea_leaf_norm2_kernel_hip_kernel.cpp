...
void tea_leaf_norm2_kernel_gpu(const ACC<double> &x,
  double * norm) {
...
int size1 ){
  ...
  if (size0==-1) dims_tea_leaf_norm2_kernel[0][0]=0;
  ...
  if (idx_x < size0 && idx_y < size1) {
    const ACC<double> argp0(dims_tea_leaf_norm2_kernel[0][0], arg0);
    tea_leaf_norm2_kernel_gpu(argp0, arg1_l);
  }
  for (int d=0; d<1; d++)
...
void ops_par_loop_tea_leaf_norm2_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_tea_leaf_norm2_kernel_h[0][0]) {
    ...
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_tea_leaf_norm2_kernel), dims_tea_leaf_norm2_kernel_h, sizeof(dims_tea_leaf_norm2_kernel)));
  }
  ...
  if (x_size > 0 && y_size > 0)
    hipLaunchKernelGGL(ops_tea_leaf_norm2_kernel,grid ,tblock ,nshared ,0 , (double *)p_a[0], (double *)arg1.data_d,x_size, y_size);
