...
int size1 ){
  ...
  for (int d=0; d<1; d++)
    ops_reduction_hip<OPS_INC>(&arg4[d+(hipBlockIdx_x+ hipBlockIdx_y*hipGridDim_x)*1],arg4_l[d]);
  for (int d=0; d<1; d++)
    ops_reduction_hip<OPS_INC>(&arg5[d+(hipBlockIdx_x+ hipBlockIdx_y*hipGridDim_x)*1],arg5_l[d]);
  for (int d=0; d<1; d++)
