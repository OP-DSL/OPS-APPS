...
void ops_par_loop_tea_leaf_recip2_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  if (xdim0 != xdim0_tea_leaf_recip2_kernel_h || xdim1 != xdim1_tea_leaf_recip2_kernel_h || xdim2 != xdim2_tea_leaf_recip2_kernel_h) {
    xdim0_tea_leaf_recip2_kernel = xdim0;
    xdim0_tea_leaf_recip2_kernel_h = xdim0;
    xdim1_tea_leaf_recip2_kernel = xdim1;
    xdim1_tea_leaf_recip2_kernel_h = xdim1;
    xdim2_tea_leaf_recip2_kernel = xdim2;
  ...
  tea_leaf_recip2_kernel_c_wrapper(
    p_a0,
    p_a1,
    p_a2,
    x_size, y_size);
