...
extern int xdim0_tea_leaf_recip_kernel;
int xdim0_tea_leaf_recip_kernel_h = -1;
extern int xdim1_tea_leaf_recip_kernel;
int xdim1_tea_leaf_recip_kernel_h = -1;
...
void ops_par_loop_tea_leaf_recip_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  if (xdim0 != xdim0_tea_leaf_recip_kernel_h || xdim1 != xdim1_tea_leaf_recip_kernel_h) {
    xdim0_tea_leaf_recip_kernel = xdim0;
    xdim0_tea_leaf_recip_kernel_h = xdim0;
    xdim1_tea_leaf_recip_kernel = xdim1;
    xdim1_tea_leaf_recip_kernel_h = xdim1;
  }
  ...
  tea_leaf_recip_kernel_c_wrapper(
    p_a0,
    p_a1,
    x_size, y_size);
