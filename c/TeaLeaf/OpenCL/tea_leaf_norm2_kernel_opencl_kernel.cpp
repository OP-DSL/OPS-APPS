...
//
    ...
    void buildOpenCLKernels_tea_leaf_norm2_kernel(OPS_instance *instance, int xdim0) {
      ...
      if(!isbuilt_tea_leaf_norm2_kernel) {
        ...
        instance->ostream() <<"Compiling tea_leaf_norm2_kernel "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_tea_leaf_norm2_kernel=%d ", pPath, 32,xdim0);
            else
              sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_tea_leaf_norm2_kernel=%d ", pPath, 32,xdim0);
          else {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[39] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_tea_leaf_norm2_kernel", &ret);
        clSafeCall( ret );
