...
//
    ...
    void buildOpenCLKernels_update_halo_kernel1_t2(OPS_instance *instance, int xdim0, int xdim1, int xdim2, int xdim3, int xdim4, int xdim5) {
      ...
      if(!isbuilt_update_halo_kernel1_t2) {
        ...
        instance->ostream() <<"Compiling update_halo_kernel1_t2 "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_update_halo_kernel1_t2=%d  -Dxdim1_update_halo_kernel1_t2=%d  -Dxdim2_update_halo_kernel1_t2=%d  -Dxdim3_update_halo_kernel1_t2=%d  -Dxdim4_update_halo_kernel1_t2=%d  -Dxdim5_update_halo_kernel1_t2=%d ", pPath, 32,xdim0,xdim1,xdim2,xdim3,xdim4,xdim5);
            else
              sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_update_halo_kernel1_t2=%d  -Dxdim1_update_halo_kernel1_t2=%d  -Dxdim2_update_halo_kernel1_t2=%d  -Dxdim3_update_halo_kernel1_t2=%d  -Dxdim4_update_halo_kernel1_t2=%d  -Dxdim5_update_halo_kernel1_t2=%d ", pPath, 32,xdim0,xdim1,xdim2,xdim3,xdim4,xdim5);
          else {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[51] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_update_halo_kernel1_t2", &ret);
        clSafeCall( ret );
...
void ops_par_loop_update_halo_kernel1_t2(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6) {
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[51], 7, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[51], 8, sizeof(cl_int), (void*) &base1 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[51], 9, sizeof(cl_int), (void*) &base2 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[51], 10, sizeof(cl_int), (void*) &base3 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[51], 11, sizeof(cl_int), (void*) &base4 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[51], 12, sizeof(cl_int), (void*) &base5 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[51], 13, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[51], 14, sizeof(cl_int), (void*) &y_size ));
