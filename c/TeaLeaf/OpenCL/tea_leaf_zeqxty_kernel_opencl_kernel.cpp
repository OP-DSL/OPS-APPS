...
//
    ...
    void buildOpenCLKernels_tea_leaf_zeqxty_kernel(OPS_instance *instance, int xdim0, int xdim1, int xdim2) {
      ...
      if(!isbuilt_tea_leaf_zeqxty_kernel) {
        ...
        instance->ostream() <<"Compiling tea_leaf_zeqxty_kernel "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_tea_leaf_zeqxty_kernel=%d  -Dxdim1_tea_leaf_zeqxty_kernel=%d  -Dxdim2_tea_leaf_zeqxty_kernel=%d ", pPath, 32,xdim0,xdim1,xdim2);
            else
              sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_tea_leaf_zeqxty_kernel=%d  -Dxdim1_tea_leaf_zeqxty_kernel=%d  -Dxdim2_tea_leaf_zeqxty_kernel=%d ", pPath, 32,xdim0,xdim1,xdim2);
          else {
          ...
          instance->ostream() << "compiling tea_leaf_zeqxty_kernel -- done\n";

        // Create the OpenCL kernel
        instance->opencl_instance->OPS_opencl_core.kernel[41] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_tea_leaf_zeqxty_kernel", &ret);
        clSafeCall( ret );
...
void ops_par_loop_tea_leaf_zeqxty_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  buildOpenCLKernels_tea_leaf_zeqxty_kernel(block->instance,
  xdim0,xdim1,xdim2);
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[41], 5, sizeof(cl_int), (void*) &base2 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[41], 6, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[41], 7, sizeof(cl_int), (void*) &y_size ));
