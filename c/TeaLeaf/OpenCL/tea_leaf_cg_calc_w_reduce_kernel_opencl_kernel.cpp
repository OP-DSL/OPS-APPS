...
//
    ...
    static bool isbuilt_tea_leaf_cg_calc_w_reduce_kernel = false;

    void buildOpenCLKernels_tea_leaf_cg_calc_w_reduce_kernel(OPS_instance *instance, int xdim0, int xdim1, int xdim2, int xdim3) {
      ...
      if(!isbuilt_tea_leaf_cg_calc_w_reduce_kernel) {
        ...
        cl_int ret;
        char* source_filename[1] = {(char*)"./OpenCL/tea_leaf_cg_calc_w_reduce_kernel.cl"};
        ...
        instance->ostream() <<"Compiling tea_leaf_cg_calc_w_reduce_kernel "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_tea_leaf_cg_calc_w_reduce_kernel=%d  -Dxdim1_tea_leaf_cg_calc_w_reduce_kernel=%d  -Dxdim2_tea_leaf_cg_calc_w_reduce_kernel=%d  -Dxdim3_tea_leaf_cg_calc_w_reduce_kernel=%d ", pPath, 32,xdim0,xdim1,xdim2,xdim3);
            else
              sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_tea_leaf_cg_calc_w_reduce_kernel=%d  -Dxdim1_tea_leaf_cg_calc_w_reduce_kernel=%d  -Dxdim2_tea_leaf_cg_calc_w_reduce_kernel=%d  -Dxdim3_tea_leaf_cg_calc_w_reduce_kernel=%d ", pPath, 32,xdim0,xdim1,xdim2,xdim3);
          else {
          ...
          instance->ostream() << "compiling tea_leaf_cg_calc_w_reduce_kernel -- done\n";

        // Create the OpenCL kernel
        instance->opencl_instance->OPS_opencl_core.kernel[19] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_tea_leaf_cg_calc_w_reduce_kernel", &ret);
        clSafeCall( ret );

        isbuilt_tea_leaf_cg_calc_w_reduce_kernel = true;
        free(source_str[0]);
      }
...
void ops_par_loop_tea_leaf_cg_calc_w_reduce_kernel(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6) {
  ...
  buildOpenCLKernels_tea_leaf_cg_calc_w_reduce_kernel(block->instance,
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[19], 4, sizeof(cl_double), (void*) arg4.data ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[19], 5, sizeof(cl_double), (void*) arg5.data ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[19], 6, sizeof(cl_mem), (void*) &arg6.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[19], 7, nthread*sizeof(double), NULL));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[19], 8, sizeof(cl_int), (void*) &r_bytes6 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[19], 9, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[19], 10, sizeof(cl_int), (void*) &base1 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[19], 11, sizeof(cl_int), (void*) &base2 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[19], 12, sizeof(cl_int), (void*) &base3 ));
