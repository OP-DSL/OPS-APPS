...
void ops_par_loop_set_field_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  #ifdef OPS_DEBUG
  ops_register_args(block->instance, args, "set_field_kernel");
  #endif
  ...
  int xdim0_set_field_kernel = args[0].dat->size[0];
  int xdim1_set_field_kernel = args[1].dat->size[0];

  //set up initial pointers and exchange halos if necessary
  int base0 = args[0].dat->base_offset;
  double * __restrict__ energy0_p = (double *)(args[0].data + base0);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      const ACC<double> energy0(xdim0_set_field_kernel, energy0_p + n_x*1 + n_y * xdim0_set_field_kernel*1);
      ACC<double> energy1(xdim1_set_field_kernel, energy1_p + n_x*1 + n_y * xdim1_set_field_kernel*1);
