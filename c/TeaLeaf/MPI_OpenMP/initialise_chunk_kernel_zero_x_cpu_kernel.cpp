...
void ops_par_loop_initialise_chunk_kernel_zero_x_execute(ops_kernel_descriptor *desc) {
  ...
  #ifdef OPS_DEBUG
  ops_register_args(block->instance, args, "initialise_chunk_kernel_zero_x");
  #endif
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ACC<double> var(xdim0_initialise_chunk_kernel_zero_x, var_p + n_x*1 + n_y * xdim0_initialise_chunk_kernel_zero_x*0);
