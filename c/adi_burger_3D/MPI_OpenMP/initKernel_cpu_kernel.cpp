...
void ops_par_loop_initKernel_execute(ops_kernel_descriptor *desc) {
  ...
  int ydim0_initKernel = args[0].dat->size[1];
  int xdim1_initKernel = args[1].dat->size[0];
  int ydim1_initKernel = args[1].dat->size[1];
  int xdim2_initKernel = args[2].dat->size[0];
  int ydim2_initKernel = args[2].dat->size[1];
  ...
  for ( int n_z=start[2]; n_z<end[2]; n_z++ ){
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        ...
        ACC<double> u(xdim0_initKernel, ydim0_initKernel, u_p + n_x*1 + n_y * xdim0_initKernel*1 + n_z * xdim0_initKernel * ydim0_initKernel*1);
        ACC<double> v(xdim1_initKernel, ydim1_initKernel, v_p + n_x*1 + n_y * xdim1_initKernel*1 + n_z * xdim1_initKernel * ydim1_initKernel*1);
        ACC<double> w(xdim2_initKernel, ydim2_initKernel, w_p + n_x*1 + n_y * xdim2_initKernel*1 + n_z * xdim2_initKernel * ydim2_initKernel*1);
