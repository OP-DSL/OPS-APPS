...
void ops_par_loop_preprocessZ_execute(ops_kernel_descriptor *desc) {
  ...
  #ifdef OPS_DEBUG
  ops_register_args(block->instance, args, "preprocessZ");
  #endif
  ...
  int xdim0_preprocessZ = args[0].dat->size[0];
  int ydim0_preprocessZ = args[0].dat->size[1];
  int xdim1_preprocessZ = args[1].dat->size[0];
  int ydim1_preprocessZ = args[1].dat->size[1];
  int xdim2_preprocessZ = args[2].dat->size[0];
  int ydim2_preprocessZ = args[2].dat->size[1];
  int xdim4_preprocessZ = args[4].dat->size[0];
  int ydim4_preprocessZ = args[4].dat->size[1];
  int xdim5_preprocessZ = args[5].dat->size[0];
  int ydim5_preprocessZ = args[5].dat->size[1];
  int xdim6_preprocessZ = args[6].dat->size[0];
  int ydim6_preprocessZ = args[6].dat->size[1];
  int xdim7_preprocessZ = args[7].dat->size[0];
  int ydim7_preprocessZ = args[7].dat->size[1];
  int xdim8_preprocessZ = args[8].dat->size[0];
  int ydim8_preprocessZ = args[8].dat->size[1];
  int xdim9_preprocessZ = args[9].dat->size[0];
  int ydim9_preprocessZ = args[9].dat->size[1];
  int xdim10_preprocessZ = args[10].dat->size[0];
  int ydim10_preprocessZ = args[10].dat->size[1];
  int xdim11_preprocessZ = args[11].dat->size[0];
  int ydim11_preprocessZ = args[11].dat->size[1];
  int xdim12_preprocessZ = args[12].dat->size[0];
  int ydim12_preprocessZ = args[12].dat->size[1];
  ...
  for ( int n_z=start[2]; n_z<end[2]; n_z++ ){
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        ...
        const ACC<double> u(xdim0_preprocessZ, ydim0_preprocessZ, u_p + n_x*1 + n_y * xdim0_preprocessZ*1 + n_z * xdim0_preprocessZ * ydim0_preprocessZ*1);
        const ACC<double> v(xdim1_preprocessZ, ydim1_preprocessZ, v_p + n_x*1 + n_y * xdim1_preprocessZ*1 + n_z * xdim1_preprocessZ * ydim1_preprocessZ*1);
        const ACC<double> w(xdim2_preprocessZ, ydim2_preprocessZ, w_p + n_x*1 + n_y * xdim2_preprocessZ*1 + n_z * xdim2_preprocessZ * ydim2_preprocessZ*1);
        ACC<double> a(xdim4_preprocessZ, ydim4_preprocessZ, a_p + n_x*1 + n_y * xdim4_preprocessZ*1 + n_z * xdim4_preprocessZ * ydim4_preprocessZ*1);
        ACC<double> b(xdim5_preprocessZ, ydim5_preprocessZ, b_p + n_x*1 + n_y * xdim5_preprocessZ*1 + n_z * xdim5_preprocessZ * ydim5_preprocessZ*1);
        ACC<double> c(xdim6_preprocessZ, ydim6_preprocessZ, c_p + n_x*1 + n_y * xdim6_preprocessZ*1 + n_z * xdim6_preprocessZ * ydim6_preprocessZ*1);
        ACC<double> du(xdim7_preprocessZ, ydim7_preprocessZ, du_p + n_x*1 + n_y * xdim7_preprocessZ*1 + n_z * xdim7_preprocessZ * ydim7_preprocessZ*1);
        ACC<double> dv(xdim8_preprocessZ, ydim8_preprocessZ, dv_p + n_x*1 + n_y * xdim8_preprocessZ*1 + n_z * xdim8_preprocessZ * ydim8_preprocessZ*1);
        ACC<double> dw(xdim9_preprocessZ, ydim9_preprocessZ, dw_p + n_x*1 + n_y * xdim9_preprocessZ*1 + n_z * xdim9_preprocessZ * ydim9_preprocessZ*1);
        ACC<double> resU(xdim10_preprocessZ, ydim10_preprocessZ, resU_p + n_x*1 + n_y * xdim10_preprocessZ*1 + n_z * xdim10_preprocessZ * ydim10_preprocessZ*1);
        ACC<double> resV(xdim11_preprocessZ, ydim11_preprocessZ, resV_p + n_x*1 + n_y * xdim11_preprocessZ*1 + n_z * xdim11_preprocessZ * ydim11_preprocessZ*1);
        ACC<double> resW(xdim12_preprocessZ, ydim12_preprocessZ, resW_p + n_x*1 + n_y * xdim12_preprocessZ*1 + n_z * xdim12_preprocessZ * ydim12_preprocessZ*1);
