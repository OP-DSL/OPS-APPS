...
void ops_par_loop_preprocessX_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_preprocessX_h[0][0] || ydim0 != dims_preprocessX_h[0][1] || xdim1 != dims_preprocessX_h[1][0] || ydim1 != dims_preprocessX_h[1][1] || xdim2 != dims_preprocessX_h[2][0] || ydim2 != dims_preprocessX_h[2][1] || xdim4 != dims_preprocessX_h[4][0] || ydim4 != dims_preprocessX_h[4][1] || xdim5 != dims_preprocessX_h[5][0] || ydim5 != dims_preprocessX_h[5][1] || xdim6 != dims_preprocessX_h[6][0] || ydim6 != dims_preprocessX_h[6][1] || xdim7 != dims_preprocessX_h[7][0] || ydim7 != dims_preprocessX_h[7][1] || xdim8 != dims_preprocessX_h[8][0] || ydim8 != dims_preprocessX_h[8][1] || xdim9 != dims_preprocessX_h[9][0] || ydim9 != dims_preprocessX_h[9][1] || xdim10 != dims_preprocessX_h[10][0] || ydim10 != dims_preprocessX_h[10][1] || xdim11 != dims_preprocessX_h[11][0] || ydim11 != dims_preprocessX_h[11][1] || xdim12 != dims_preprocessX_h[12][0] || ydim12 != dims_preprocessX_h[12][1]) {
    ...
    cutilSafeCall(block->instance->ostream(), cudaMemcpyToSymbol( dims_preprocessX, dims_preprocessX_h, sizeof(dims_preprocessX)));
  }
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    ops_preprocessX<<<grid, tblock >>> (  (double *)p_a[0], (double *)p_a[1],
