  ...
  for ( int n_z=0; n_z<z_size; n_z++ ){
    for ( int n_y=0; n_y<y_size; n_y++ ){
      for ( int n_x=0; n_x<x_size; n_x++ ){
        ...
        const ptr_double u = { u_p + n_x*1 + n_y * xdim0_preprocessZ*1 + n_z * xdim0_preprocessZ * ydim0_preprocessZ*1, xdim0_preprocessZ, ydim0_preprocessZ};
        const ptr_double v = { v_p + n_x*1 + n_y * xdim1_preprocessZ*1 + n_z * xdim1_preprocessZ * ydim1_preprocessZ*1, xdim1_preprocessZ, ydim1_preprocessZ};
        const ptr_double w = { w_p + n_x*1 + n_y * xdim2_preprocessZ*1 + n_z * xdim2_preprocessZ * ydim2_preprocessZ*1, xdim2_preprocessZ, ydim2_preprocessZ};
        ptr_double a = { a_p + n_x*1 + n_y * xdim4_preprocessZ*1 + n_z * xdim4_preprocessZ * ydim4_preprocessZ*1, xdim4_preprocessZ, ydim4_preprocessZ};
        ptr_double b = { b_p + n_x*1 + n_y * xdim5_preprocessZ*1 + n_z * xdim5_preprocessZ * ydim5_preprocessZ*1, xdim5_preprocessZ, ydim5_preprocessZ};
        ptr_double c = { c_p + n_x*1 + n_y * xdim6_preprocessZ*1 + n_z * xdim6_preprocessZ * ydim6_preprocessZ*1, xdim6_preprocessZ, ydim6_preprocessZ};
        ptr_double du = { du_p + n_x*1 + n_y * xdim7_preprocessZ*1 + n_z * xdim7_preprocessZ * ydim7_preprocessZ*1, xdim7_preprocessZ, ydim7_preprocessZ};
        ptr_double dv = { dv_p + n_x*1 + n_y * xdim8_preprocessZ*1 + n_z * xdim8_preprocessZ * ydim8_preprocessZ*1, xdim8_preprocessZ, ydim8_preprocessZ};
        ptr_double dw = { dw_p + n_x*1 + n_y * xdim9_preprocessZ*1 + n_z * xdim9_preprocessZ * ydim9_preprocessZ*1, xdim9_preprocessZ, ydim9_preprocessZ};
        ptr_double resU = { resU_p + n_x*1 + n_y * xdim10_preprocessZ*1 + n_z * xdim10_preprocessZ * ydim10_preprocessZ*1, xdim10_preprocessZ, ydim10_preprocessZ};
        ptr_double resV = { resV_p + n_x*1 + n_y * xdim11_preprocessZ*1 + n_z * xdim11_preprocessZ * ydim11_preprocessZ*1, xdim11_preprocessZ, ydim11_preprocessZ};
        ptr_double resW = { resW_p + n_x*1 + n_y * xdim12_preprocessZ*1 + n_z * xdim12_preprocessZ * ydim12_preprocessZ*1, xdim12_preprocessZ, ydim12_preprocessZ};
