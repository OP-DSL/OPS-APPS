...
//
__constant__ int dims_preprocessX [14][2];
static int dims_preprocessX_h [14][2] = {{0}};

//user function
__device__

void preprocessX_gpu(const ACC<double> &u,
  const ACC<double> &v,
  const ACC<double> &w,
  const double *time,
  ACC<double> &a,
...
__global__ void ops_preprocessX(
...
int size2 ){
  ...
  if (size0==-1) dims_preprocessX[0][0]=0;
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * dims_preprocessX[0][0] + idx_z * 1*1 * dims_preprocessX[0][0] * dims_preprocessX[0][1];
  arg1 += idx_x * 1*1 + idx_y * 1*1 * dims_preprocessX[1][0] + idx_z * 1*1 * dims_preprocessX[1][0] * dims_preprocessX[1][1];
  arg2 += idx_x * 1*1 + idx_y * 1*1 * dims_preprocessX[2][0] + idx_z * 1*1 * dims_preprocessX[2][0] * dims_preprocessX[2][1];
  arg4 += idx_x * 1*1 + idx_y * 1*1 * dims_preprocessX[4][0] + idx_z * 1*1 * dims_preprocessX[4][0] * dims_preprocessX[4][1];
  arg5 += idx_x * 1*1 + idx_y * 1*1 * dims_preprocessX[5][0] + idx_z * 1*1 * dims_preprocessX[5][0] * dims_preprocessX[5][1];
  arg6 += idx_x * 1*1 + idx_y * 1*1 * dims_preprocessX[6][0] + idx_z * 1*1 * dims_preprocessX[6][0] * dims_preprocessX[6][1];
  arg7 += idx_x * 1*1 + idx_y * 1*1 * dims_preprocessX[7][0] + idx_z * 1*1 * dims_preprocessX[7][0] * dims_preprocessX[7][1];
  arg8 += idx_x * 1*1 + idx_y * 1*1 * dims_preprocessX[8][0] + idx_z * 1*1 * dims_preprocessX[8][0] * dims_preprocessX[8][1];
  arg9 += idx_x * 1*1 + idx_y * 1*1 * dims_preprocessX[9][0] + idx_z * 1*1 * dims_preprocessX[9][0] * dims_preprocessX[9][1];
  arg10 += idx_x * 1*1 + idx_y * 1*1 * dims_preprocessX[10][0] + idx_z * 1*1 * dims_preprocessX[10][0] * dims_preprocessX[10][1];
  arg11 += idx_x * 1*1 + idx_y * 1*1 * dims_preprocessX[11][0] + idx_z * 1*1 * dims_preprocessX[11][0] * dims_preprocessX[11][1];
  arg12 += idx_x * 1*1 + idx_y * 1*1 * dims_preprocessX[12][0] + idx_z * 1*1 * dims_preprocessX[12][0] * dims_preprocessX[12][1];

  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    const ACC<double> argp0(dims_preprocessX[0][0], dims_preprocessX[0][1], arg0);
    const ACC<double> argp1(dims_preprocessX[1][0], dims_preprocessX[1][1], arg1);
    const ACC<double> argp2(dims_preprocessX[2][0], dims_preprocessX[2][1], arg2);
    ACC<double> argp4(dims_preprocessX[4][0], dims_preprocessX[4][1], arg4);
    ACC<double> argp5(dims_preprocessX[5][0], dims_preprocessX[5][1], arg5);
    ACC<double> argp6(dims_preprocessX[6][0], dims_preprocessX[6][1], arg6);
    ACC<double> argp7(dims_preprocessX[7][0], dims_preprocessX[7][1], arg7);
    ACC<double> argp8(dims_preprocessX[8][0], dims_preprocessX[8][1], arg8);
    ACC<double> argp9(dims_preprocessX[9][0], dims_preprocessX[9][1], arg9);
    ACC<double> argp10(dims_preprocessX[10][0], dims_preprocessX[10][1], arg10);
    ACC<double> argp11(dims_preprocessX[11][0], dims_preprocessX[11][1], arg11);
    ACC<double> argp12(dims_preprocessX[12][0], dims_preprocessX[12][1], arg12);
    preprocessX_gpu(argp0, argp1, argp2, &arg3,
...
void ops_par_loop_preprocessX_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_preprocessX_h[0][0] || ydim0 != dims_preprocessX_h[0][1] || xdim1 != dims_preprocessX_h[1][0] || ydim1 != dims_preprocessX_h[1][1] || xdim2 != dims_preprocessX_h[2][0] || ydim2 != dims_preprocessX_h[2][1] || xdim4 != dims_preprocessX_h[4][0] || ydim4 != dims_preprocessX_h[4][1] || xdim5 != dims_preprocessX_h[5][0] || ydim5 != dims_preprocessX_h[5][1] || xdim6 != dims_preprocessX_h[6][0] || ydim6 != dims_preprocessX_h[6][1] || xdim7 != dims_preprocessX_h[7][0] || ydim7 != dims_preprocessX_h[7][1] || xdim8 != dims_preprocessX_h[8][0] || ydim8 != dims_preprocessX_h[8][1] || xdim9 != dims_preprocessX_h[9][0] || ydim9 != dims_preprocessX_h[9][1] || xdim10 != dims_preprocessX_h[10][0] || ydim10 != dims_preprocessX_h[10][1] || xdim11 != dims_preprocessX_h[11][0] || ydim11 != dims_preprocessX_h[11][1] || xdim12 != dims_preprocessX_h[12][0] || ydim12 != dims_preprocessX_h[12][1]) {
    dims_preprocessX_h[0][0] = xdim0;
    dims_preprocessX_h[0][1] = ydim0;
    dims_preprocessX_h[1][0] = xdim1;
    dims_preprocessX_h[1][1] = ydim1;
    dims_preprocessX_h[2][0] = xdim2;
    dims_preprocessX_h[2][1] = ydim2;
    dims_preprocessX_h[4][0] = xdim4;
    dims_preprocessX_h[4][1] = ydim4;
    dims_preprocessX_h[5][0] = xdim5;
    dims_preprocessX_h[5][1] = ydim5;
    dims_preprocessX_h[6][0] = xdim6;
    dims_preprocessX_h[6][1] = ydim6;
    dims_preprocessX_h[7][0] = xdim7;
    dims_preprocessX_h[7][1] = ydim7;
    dims_preprocessX_h[8][0] = xdim8;
    dims_preprocessX_h[8][1] = ydim8;
    dims_preprocessX_h[9][0] = xdim9;
    dims_preprocessX_h[9][1] = ydim9;
    dims_preprocessX_h[10][0] = xdim10;
    dims_preprocessX_h[10][1] = ydim10;
    dims_preprocessX_h[11][0] = xdim11;
    dims_preprocessX_h[11][1] = ydim11;
    dims_preprocessX_h[12][0] = xdim12;
    dims_preprocessX_h[12][1] = ydim12;
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_preprocessX), dims_preprocessX_h, sizeof(dims_preprocessX)));
  }
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    hipLaunchKernelGGL(ops_preprocessX,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],
