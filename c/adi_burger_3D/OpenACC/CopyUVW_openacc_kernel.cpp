...
extern int xdim0_CopyUVW;
int xdim0_CopyUVW_h = -1;
extern int ydim0_CopyUVW;
int ydim0_CopyUVW_h = -1;
extern int xdim1_CopyUVW;
int xdim1_CopyUVW_h = -1;
extern int ydim1_CopyUVW;
int ydim1_CopyUVW_h = -1;
extern int xdim2_CopyUVW;
int xdim2_CopyUVW_h = -1;
extern int ydim2_CopyUVW;
int ydim2_CopyUVW_h = -1;
extern int xdim3_CopyUVW;
int xdim3_CopyUVW_h = -1;
extern int ydim3_CopyUVW;
int ydim3_CopyUVW_h = -1;
extern int xdim4_CopyUVW;
int xdim4_CopyUVW_h = -1;
extern int ydim4_CopyUVW;
int ydim4_CopyUVW_h = -1;
extern int xdim5_CopyUVW;
int xdim5_CopyUVW_h = -1;
extern int ydim5_CopyUVW;
int ydim5_CopyUVW_h = -1;
...
void ops_par_loop_CopyUVW(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3, ops_arg arg4, ops_arg arg5) {
  ...
  if (xdim0 != xdim0_CopyUVW_h || ydim0 != ydim0_CopyUVW_h || xdim1 != xdim1_CopyUVW_h || ydim1 != ydim1_CopyUVW_h || xdim2 != xdim2_CopyUVW_h || ydim2 != ydim2_CopyUVW_h || xdim3 != xdim3_CopyUVW_h || ydim3 != ydim3_CopyUVW_h || xdim4 != xdim4_CopyUVW_h || ydim4 != ydim4_CopyUVW_h || xdim5 != xdim5_CopyUVW_h || ydim5 != ydim5_CopyUVW_h) {
    xdim0_CopyUVW = xdim0;
    xdim0_CopyUVW_h = xdim0;
    ydim0_CopyUVW = ydim0;
    ydim0_CopyUVW_h = ydim0;
    xdim1_CopyUVW = xdim1;
    xdim1_CopyUVW_h = xdim1;
    ydim1_CopyUVW = ydim1;
    ydim1_CopyUVW_h = ydim1;
    xdim2_CopyUVW = xdim2;
    xdim2_CopyUVW_h = xdim2;
    ydim2_CopyUVW = ydim2;
    ydim2_CopyUVW_h = ydim2;
    xdim3_CopyUVW = xdim3;
    xdim3_CopyUVW_h = xdim3;
    ydim3_CopyUVW = ydim3;
    ydim3_CopyUVW_h = ydim3;
    xdim4_CopyUVW = xdim4;
    xdim4_CopyUVW_h = xdim4;
    ydim4_CopyUVW = ydim4;
    ydim4_CopyUVW_h = ydim4;
    xdim5_CopyUVW = xdim5;
    xdim5_CopyUVW_h = xdim5;
    ydim5_CopyUVW = ydim5;
    ydim5_CopyUVW_h = ydim5;
  }
