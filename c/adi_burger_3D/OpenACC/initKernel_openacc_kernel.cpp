...
extern int xdim0_initKernel;
int xdim0_initKernel_h = -1;
extern int ydim0_initKernel;
int ydim0_initKernel_h = -1;
extern int xdim1_initKernel;
int xdim1_initKernel_h = -1;
extern int ydim1_initKernel;
int ydim1_initKernel_h = -1;
extern int xdim2_initKernel;
int xdim2_initKernel_h = -1;
extern int ydim2_initKernel;
int ydim2_initKernel_h = -1;
...
void ops_par_loop_initKernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
  ...
  if (xdim0 != xdim0_initKernel_h || ydim0 != ydim0_initKernel_h || xdim1 != xdim1_initKernel_h || ydim1 != ydim1_initKernel_h || xdim2 != xdim2_initKernel_h || ydim2 != ydim2_initKernel_h) {
    xdim0_initKernel = xdim0;
    xdim0_initKernel_h = xdim0;
    ydim0_initKernel = ydim0;
    ydim0_initKernel_h = ydim0;
    xdim1_initKernel = xdim1;
    xdim1_initKernel_h = xdim1;
    ydim1_initKernel = ydim1;
    ydim1_initKernel_h = ydim1;
    xdim2_initKernel = xdim2;
    xdim2_initKernel_h = xdim2;
    ydim2_initKernel = ydim2;
    ydim2_initKernel_h = ydim2;
  }
