...
//
    ...
    static bool isbuilt_CopyUVW = false;

    void buildOpenCLKernels_CopyUVW(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3, int xdim4, int ydim4, int xdim5, int ydim5) {
      ...
      if(!isbuilt_CopyUVW) {
        ...
        cl_int ret;
        char* source_filename[1] = {(char*)"./OpenCL/CopyUVW.cl"};
        ...
        instance->ostream() <<"Compiling CopyUVW "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_CopyUVW=%d  -Dydim0_CopyUVW=%d  -Dxdim1_CopyUVW=%d  -Dydim1_CopyUVW=%d  -Dxdim2_CopyUVW=%d  -Dydim2_CopyUVW=%d  -Dxdim3_CopyUVW=%d  -Dydim3_CopyUVW=%d  -Dxdim4_CopyUVW=%d  -Dydim4_CopyUVW=%d  -Dxdim5_CopyUVW=%d  -Dydim5_CopyUVW=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1,xdim2,ydim2,xdim3,ydim3,xdim4,ydim4,xdim5,ydim5);
            else
          ...
          instance->ostream() << "compiling CopyUVW -- done\n";

        // Create the OpenCL kernel
        instance->opencl_instance->OPS_opencl_core.kernel[1] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_CopyUVW", &ret);
        clSafeCall( ret );

        isbuilt_CopyUVW = true;
        free(source_str[0]);
      }
...
void ops_par_loop_CopyUVW(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5) {
  ...
  buildOpenCLKernels_CopyUVW(block->instance,
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 10, sizeof(cl_int), (void*) &base4 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 11, sizeof(cl_int), (void*) &base5 ));
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 14, sizeof(cl_int), (void*) &z_size ));
