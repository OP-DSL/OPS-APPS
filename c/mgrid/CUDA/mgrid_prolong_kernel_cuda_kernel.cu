...
void ops_par_loop_mgrid_prolong_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_mgrid_prolong_kernel_h[0][0] || xdim1 != dims_mgrid_prolong_kernel_h[1][0]) {
    ...
    cutilSafeCall(block->instance->ostream(), cudaMemcpyToSymbol( dims_mgrid_prolong_kernel, dims_mgrid_prolong_kernel_h, sizeof(dims_mgrid_prolong_kernel)));
  }
  ...
  if (x_size > 0 && y_size > 0)
    ops_mgrid_prolong_kernel<<<grid, tblock >>> (  (double *)p_a[0],stride_0[0],stride_0[1], (double *)p_a[1],
