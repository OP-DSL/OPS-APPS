...
extern int xdim0_mgrid_populate_kernel_3;
int xdim0_mgrid_populate_kernel_3_h = -1;
...
void ops_par_loop_mgrid_populate_kernel_3(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  if (xdim0 != xdim0_mgrid_populate_kernel_3_h) {
    xdim0_mgrid_populate_kernel_3 = xdim0;
    xdim0_mgrid_populate_kernel_3_h = xdim0;
  }
  ...
  mgrid_populate_kernel_3_c_wrapper(
    p_a0,
    p_a1,
    arg_idx[0], arg_idx[1],
    x_size, y_size);
