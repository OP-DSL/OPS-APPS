...
extern int xdim0_restrict_check;
int xdim0_restrict_check_h = -1;
...
void ops_par_loop_restrict_check(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
  ...
  if (xdim0 != xdim0_restrict_check_h) {
    xdim0_restrict_check = xdim0;
    xdim0_restrict_check_h = xdim0;
  }
