...
int size1 ){
  ...
  if (size0==-1) dims_mgrid_restrict_kernel[0][0]=0;
...
void ops_par_loop_mgrid_restrict_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_mgrid_restrict_kernel_h[0][0] || xdim1 != dims_mgrid_restrict_kernel_h[1][0]) {
    ...
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_mgrid_restrict_kernel), dims_mgrid_restrict_kernel_h, sizeof(dims_mgrid_restrict_kernel)));
  }
  ...
  if (x_size > 0 && y_size > 0)
    hipLaunchKernelGGL(ops_mgrid_restrict_kernel,grid ,tblock ,0 ,0 , (double *)p_a[0],stride_0[0],stride_0[1], (double *)p_a[1],
