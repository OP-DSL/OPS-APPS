...
//
__constant__ int dims_generate_chunk_kernel [11][2];
static int dims_generate_chunk_kernel_h [11][2] = {0};
...
int size2 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 0*1 * dims_generate_chunk_kernel[0][0] + idx_z * 0*1 * dims_generate_chunk_kernel[0][0] * dims_generate_chunk_kernel[0][1];
  arg1 += idx_x * 0*1 + idx_y * 1*1 * dims_generate_chunk_kernel[1][0] + idx_z * 0*1 * dims_generate_chunk_kernel[1][0] * dims_generate_chunk_kernel[1][1];
  arg2 += idx_x * 0*1 + idx_y * 0*1 * dims_generate_chunk_kernel[2][0] + idx_z * 1*1 * dims_generate_chunk_kernel[2][0] * dims_generate_chunk_kernel[2][1];
  arg3 += idx_x * 1*1 + idx_y * 1*1 * dims_generate_chunk_kernel[3][0] + idx_z * 1*1 * dims_generate_chunk_kernel[3][0] * dims_generate_chunk_kernel[3][1];
  arg4 += idx_x * 1*1 + idx_y * 1*1 * dims_generate_chunk_kernel[4][0] + idx_z * 1*1 * dims_generate_chunk_kernel[4][0] * dims_generate_chunk_kernel[4][1];
  arg5 += idx_x * 1*1 + idx_y * 1*1 * dims_generate_chunk_kernel[5][0] + idx_z * 1*1 * dims_generate_chunk_kernel[5][0] * dims_generate_chunk_kernel[5][1];
  arg6 += idx_x * 1*1 + idx_y * 1*1 * dims_generate_chunk_kernel[6][0] + idx_z * 1*1 * dims_generate_chunk_kernel[6][0] * dims_generate_chunk_kernel[6][1];
  arg7 += idx_x * 1*1 + idx_y * 1*1 * dims_generate_chunk_kernel[7][0] + idx_z * 1*1 * dims_generate_chunk_kernel[7][0] * dims_generate_chunk_kernel[7][1];
  arg8 += idx_x * 1*1 + idx_y * 0*1 * dims_generate_chunk_kernel[8][0] + idx_z * 0*1 * dims_generate_chunk_kernel[8][0] * dims_generate_chunk_kernel[8][1];
  arg9 += idx_x * 0*1 + idx_y * 1*1 * dims_generate_chunk_kernel[9][0] + idx_z * 0*1 * dims_generate_chunk_kernel[9][0] * dims_generate_chunk_kernel[9][1];
  arg10 += idx_x * 0*1 + idx_y * 0*1 * dims_generate_chunk_kernel[10][0] + idx_z * 1*1 * dims_generate_chunk_kernel[10][0] * dims_generate_chunk_kernel[10][1];

  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    const ACC<double> argp0(dims_generate_chunk_kernel[0][0], dims_generate_chunk_kernel[0][1], arg0);
    const ACC<double> argp1(dims_generate_chunk_kernel[1][0], dims_generate_chunk_kernel[1][1], arg1);
    const ACC<double> argp2(dims_generate_chunk_kernel[2][0], dims_generate_chunk_kernel[2][1], arg2);
    ACC<double> argp3(dims_generate_chunk_kernel[3][0], dims_generate_chunk_kernel[3][1], arg3);
    ACC<double> argp4(dims_generate_chunk_kernel[4][0], dims_generate_chunk_kernel[4][1], arg4);
    ACC<double> argp5(dims_generate_chunk_kernel[5][0], dims_generate_chunk_kernel[5][1], arg5);
    ACC<double> argp6(dims_generate_chunk_kernel[6][0], dims_generate_chunk_kernel[6][1], arg6);
    ACC<double> argp7(dims_generate_chunk_kernel[7][0], dims_generate_chunk_kernel[7][1], arg7);
    const ACC<double> argp8(dims_generate_chunk_kernel[8][0], dims_generate_chunk_kernel[8][1], arg8);
    const ACC<double> argp9(dims_generate_chunk_kernel[9][0], dims_generate_chunk_kernel[9][1], arg9);
    const ACC<double> argp10(dims_generate_chunk_kernel[10][0], dims_generate_chunk_kernel[10][1], arg10);
