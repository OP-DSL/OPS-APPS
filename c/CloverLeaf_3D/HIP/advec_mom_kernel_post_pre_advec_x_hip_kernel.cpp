...
int size2 ){
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ...
    advec_mom_kernel_post_pre_advec_x_gpu(argp0, argp1, argp2, argp3,
                   argp4);
  }
...
void ops_par_loop_advec_mom_kernel_post_pre_advec_x_execute(ops_kernel_descriptor *desc) {
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    hipLaunchKernelGGL(ops_advec_mom_kernel_post_pre_advec_x,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],
