...
int size2 ){
  ...
  for (int d=0; d<1; d++)
    ops_reduction_hip<OPS_MIN>(&arg1[d+(hipBlockIdx_x + hipBlockIdx_y*hipGridDim_x + hipBlockIdx_z*hipGridDim_x*hipGridDim_y)*1],arg1_l[d]);
...
void ops_par_loop_calc_dt_kernel_min_execute(ops_kernel_descriptor *desc) {
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    hipLaunchKernelGGL(ops_calc_dt_kernel_min,grid ,tblock ,nshared ,0 , (double *)p_a[0], (double *)arg1.data_d,x_size, y_size, z_size);
