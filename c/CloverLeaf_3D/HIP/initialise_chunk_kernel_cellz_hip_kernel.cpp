...
int size2 ){
  ...
  if (size0==-1) dims_initialise_chunk_kernel_cellz[0][0]=0;
  ...
  arg0 += idx_x * 0*1 + idx_y * 0*1 * dims_initialise_chunk_kernel_cellz[0][0] + idx_z * 1*1 * dims_initialise_chunk_kernel_cellz[0][0] * dims_initialise_chunk_kernel_cellz[0][1];
  arg1 += idx_x * 0*1 + idx_y * 0*1 * dims_initialise_chunk_kernel_cellz[1][0] + idx_z * 1*1 * dims_initialise_chunk_kernel_cellz[1][0] * dims_initialise_chunk_kernel_cellz[1][1];
...
void ops_par_loop_initialise_chunk_kernel_cellz_execute(ops_kernel_descriptor *desc) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,8,"initialise_chunk_kernel_cellz");
  ...
  if (xdim0 != dims_initialise_chunk_kernel_cellz_h[0][0] || ydim0 != dims_initialise_chunk_kernel_cellz_h[0][1] || xdim1 != dims_initialise_chunk_kernel_cellz_h[1][0] || ydim1 != dims_initialise_chunk_kernel_cellz_h[1][1] || xdim2 != dims_initialise_chunk_kernel_cellz_h[2][0] || ydim2 != dims_initialise_chunk_kernel_cellz_h[2][1]) {
    dims_initialise_chunk_kernel_cellz_h[0][0] = xdim0;
    dims_initialise_chunk_kernel_cellz_h[0][1] = ydim0;
    dims_initialise_chunk_kernel_cellz_h[1][0] = xdim1;
    dims_initialise_chunk_kernel_cellz_h[1][1] = ydim1;
    dims_initialise_chunk_kernel_cellz_h[2][0] = xdim2;
    dims_initialise_chunk_kernel_cellz_h[2][1] = ydim2;
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_initialise_chunk_kernel_cellz), dims_initialise_chunk_kernel_cellz_h, sizeof(dims_initialise_chunk_kernel_cellz)));
  }
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    hipLaunchKernelGGL(ops_initialise_chunk_kernel_cellz,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],
