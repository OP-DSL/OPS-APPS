...
//
__constant__ int dims_update_halo_kernel4_plus_2_a [3][2];
static int dims_update_halo_kernel4_plus_2_a_h [3][2] = {{0}};
...
int size2 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * dims_update_halo_kernel4_plus_2_a[0][0] + idx_z * 1*1 * dims_update_halo_kernel4_plus_2_a[0][0] * dims_update_halo_kernel4_plus_2_a[0][1];
  arg1 += idx_x * 1*1 + idx_y * 1*1 * dims_update_halo_kernel4_plus_2_a[1][0] + idx_z * 1*1 * dims_update_halo_kernel4_plus_2_a[1][0] * dims_update_halo_kernel4_plus_2_a[1][1];

  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ACC<double> argp0(dims_update_halo_kernel4_plus_2_a[0][0], dims_update_halo_kernel4_plus_2_a[0][1], arg0);
    ACC<double> argp1(dims_update_halo_kernel4_plus_2_a[1][0], dims_update_halo_kernel4_plus_2_a[1][1], arg1);
...
void ops_par_loop_update_halo_kernel4_plus_2_a_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_update_halo_kernel4_plus_2_a_h[0][0] || ydim0 != dims_update_halo_kernel4_plus_2_a_h[0][1] || xdim1 != dims_update_halo_kernel4_plus_2_a_h[1][0] || ydim1 != dims_update_halo_kernel4_plus_2_a_h[1][1]) {
    dims_update_halo_kernel4_plus_2_a_h[0][0] = xdim0;
    dims_update_halo_kernel4_plus_2_a_h[0][1] = ydim0;
    dims_update_halo_kernel4_plus_2_a_h[1][0] = xdim1;
    dims_update_halo_kernel4_plus_2_a_h[1][1] = ydim1;
