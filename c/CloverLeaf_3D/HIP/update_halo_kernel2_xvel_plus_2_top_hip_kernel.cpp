...
int size2 ){
  ...
  if (size0==-1) dims_update_halo_kernel2_xvel_plus_2_top[0][0]=0;
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * dims_update_halo_kernel2_xvel_plus_2_top[0][0] + idx_z * 1*1 * dims_update_halo_kernel2_xvel_plus_2_top[0][0] * dims_update_halo_kernel2_xvel_plus_2_top[0][1];
...
void ops_par_loop_update_halo_kernel2_xvel_plus_2_top_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_update_halo_kernel2_xvel_plus_2_top_h[0][0] || ydim0 != dims_update_halo_kernel2_xvel_plus_2_top_h[0][1] || xdim1 != dims_update_halo_kernel2_xvel_plus_2_top_h[1][0] || ydim1 != dims_update_halo_kernel2_xvel_plus_2_top_h[1][1]) {
    dims_update_halo_kernel2_xvel_plus_2_top_h[0][0] = xdim0;
    dims_update_halo_kernel2_xvel_plus_2_top_h[0][1] = ydim0;
    dims_update_halo_kernel2_xvel_plus_2_top_h[1][0] = xdim1;
    dims_update_halo_kernel2_xvel_plus_2_top_h[1][1] = ydim1;
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_update_halo_kernel2_xvel_plus_2_top), dims_update_halo_kernel2_xvel_plus_2_top_h, sizeof(dims_update_halo_kernel2_xvel_plus_2_top)));
  }
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    hipLaunchKernelGGL(ops_update_halo_kernel2_xvel_plus_2_top,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],
