...
int size2 ){
  ...
  if (size0==-1) dims_update_halo_kernel2_xvel_plus_2_front[0][0]=0;
...
void ops_par_loop_update_halo_kernel2_xvel_plus_2_front_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_update_halo_kernel2_xvel_plus_2_front_h[0][0] || ydim0 != dims_update_halo_kernel2_xvel_plus_2_front_h[0][1] || xdim1 != dims_update_halo_kernel2_xvel_plus_2_front_h[1][0] || ydim1 != dims_update_halo_kernel2_xvel_plus_2_front_h[1][1]) {
    ...
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_update_halo_kernel2_xvel_plus_2_front), dims_update_halo_kernel2_xvel_plus_2_front_h, sizeof(dims_update_halo_kernel2_xvel_plus_2_front)));
  }
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    hipLaunchKernelGGL(ops_update_halo_kernel2_xvel_plus_2_front,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],
