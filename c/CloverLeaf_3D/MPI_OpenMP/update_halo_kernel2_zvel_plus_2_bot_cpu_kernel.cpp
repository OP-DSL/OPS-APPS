...
void ops_par_loop_update_halo_kernel2_zvel_plus_2_bot_execute(ops_kernel_descriptor *desc) {
  ...
  #ifdef OPS_DEBUG
  ops_register_args(block->instance, args, "update_halo_kernel2_zvel_plus_2_bot");
  #endif
  ...
  for ( int n_z=start[2]; n_z<end[2]; n_z++ ){
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        ACC<double> zvel0(xdim0_update_halo_kernel2_zvel_plus_2_bot, ydim0_update_halo_kernel2_zvel_plus_2_bot, zvel0_p + n_x*1 + n_y * xdim0_update_halo_kernel2_zvel_plus_2_bot*1 + n_z * xdim0_update_halo_kernel2_zvel_plus_2_bot * ydim0_update_halo_kernel2_zvel_plus_2_bot*1);
        ACC<double> zvel1(xdim1_update_halo_kernel2_zvel_plus_2_bot, ydim1_update_halo_kernel2_zvel_plus_2_bot, zvel1_p + n_x*1 + n_y * xdim1_update_halo_kernel2_zvel_plus_2_bot*1 + n_z * xdim1_update_halo_kernel2_zvel_plus_2_bot * ydim1_update_halo_kernel2_zvel_plus_2_bot*1);
