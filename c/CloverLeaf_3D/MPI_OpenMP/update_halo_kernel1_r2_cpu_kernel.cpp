...
void ops_par_loop_update_halo_kernel1_r2_execute(ops_kernel_descriptor *desc) {
  ...
  #ifdef OPS_DEBUG
  ops_register_args(block->instance, args, "update_halo_kernel1_r2");
  #endif
  ...
  for ( int n_z=start[2]; n_z<end[2]; n_z++ ){
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        ACC<double> density0(xdim0_update_halo_kernel1_r2, ydim0_update_halo_kernel1_r2, density0_p + n_x*1 + n_y * xdim0_update_halo_kernel1_r2*1 + n_z * xdim0_update_halo_kernel1_r2 * ydim0_update_halo_kernel1_r2*1);
        ACC<double> density1(xdim1_update_halo_kernel1_r2, ydim1_update_halo_kernel1_r2, density1_p + n_x*1 + n_y * xdim1_update_halo_kernel1_r2*1 + n_z * xdim1_update_halo_kernel1_r2 * ydim1_update_halo_kernel1_r2*1);
        ACC<double> energy0(xdim2_update_halo_kernel1_r2, ydim2_update_halo_kernel1_r2, energy0_p + n_x*1 + n_y * xdim2_update_halo_kernel1_r2*1 + n_z * xdim2_update_halo_kernel1_r2 * ydim2_update_halo_kernel1_r2*1);
        ACC<double> energy1(xdim3_update_halo_kernel1_r2, ydim3_update_halo_kernel1_r2, energy1_p + n_x*1 + n_y * xdim3_update_halo_kernel1_r2*1 + n_z * xdim3_update_halo_kernel1_r2 * ydim3_update_halo_kernel1_r2*1);
        ACC<double> pressure(xdim4_update_halo_kernel1_r2, ydim4_update_halo_kernel1_r2, pressure_p + n_x*1 + n_y * xdim4_update_halo_kernel1_r2*1 + n_z * xdim4_update_halo_kernel1_r2 * ydim4_update_halo_kernel1_r2*1);
        ACC<double> viscosity(xdim5_update_halo_kernel1_r2, ydim5_update_halo_kernel1_r2, viscosity_p + n_x*1 + n_y * xdim5_update_halo_kernel1_r2*1 + n_z * xdim5_update_halo_kernel1_r2 * ydim5_update_halo_kernel1_r2*1);
        ACC<double> soundspeed(xdim6_update_halo_kernel1_r2, ydim6_update_halo_kernel1_r2, soundspeed_p + n_x*1 + n_y * xdim6_update_halo_kernel1_r2*1 + n_z * xdim6_update_halo_kernel1_r2 * ydim6_update_halo_kernel1_r2*1);
