...
//
    ...
    void buildOpenCLKernels_advec_mom_kernel_x1(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3, int xdim4, int ydim4, int xdim5, int ydim5) {
      ...
      if(!isbuilt_advec_mom_kernel_x1) {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[121] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_advec_mom_kernel_x1", &ret);
        clSafeCall( ret );
...
void ops_par_loop_advec_mom_kernel_x1(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,121,"advec_mom_kernel_x1");
