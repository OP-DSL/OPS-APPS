...
//
    ...
    void buildOpenCLKernels_calc_dt_kernel_min(OPS_instance *instance, int xdim0, int ydim0) {
      ...
      if(!isbuilt_calc_dt_kernel_min) {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[99] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_calc_dt_kernel_min", &ret);
        clSafeCall( ret );
