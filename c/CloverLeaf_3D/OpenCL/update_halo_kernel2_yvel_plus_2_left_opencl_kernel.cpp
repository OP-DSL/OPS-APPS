...
//
    ...
    void buildOpenCLKernels_update_halo_kernel2_yvel_plus_2_left(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1) {
      ...
      if(!isbuilt_update_halo_kernel2_yvel_plus_2_left) {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[41] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_update_halo_kernel2_yvel_plus_2_left", &ret);
        clSafeCall( ret );
