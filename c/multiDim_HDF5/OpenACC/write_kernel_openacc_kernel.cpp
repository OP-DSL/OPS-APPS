...
extern int xdim3_write_kernel;
int xdim3_write_kernel_h = -1;
extern int ydim3_write_kernel;
int ydim3_write_kernel_h = -1;
extern int xdim4_write_kernel;
int xdim4_write_kernel_h = -1;
extern int ydim4_write_kernel;
int ydim4_write_kernel_h = -1;
extern int xdim5_write_kernel;
int xdim5_write_kernel_h = -1;
extern int ydim5_write_kernel;
int ydim5_write_kernel_h = -1;
extern int xdim6_write_kernel;
int xdim6_write_kernel_h = -1;
extern int ydim6_write_kernel;
int ydim6_write_kernel_h = -1;
...
void ops_par_loop_write_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3, ops_arg arg4, ops_arg arg5, ops_arg arg6, ops_arg arg7) {
  ...
  #ifdef OPS_GPU
  char *p_a3 = (char *)((char *)args[3].data_d + base3);
  #else
  char *p_a3 = (char *)((char *)args[3].data + base3);
  #endif
  ...
  #ifdef OPS_GPU
  short *p_a4 = (short *)((char *)args[4].data_d + base4);
  #else
  short *p_a4 = (short *)((char *)args[4].data + base4);
  #endif
  ...
  #ifdef OPS_GPU
  long *p_a5 = (long *)((char *)args[5].data_d + base5);
  #else
  long *p_a5 = (long *)((char *)args[5].data + base5);
  #endif
  ...
  #ifdef OPS_GPU
  ll *p_a6 = (ll *)((char *)args[6].data_d + base6);
  #else
  ll *p_a6 = (ll *)((char *)args[6].data + base6);
  #endif
  ...
  if (xdim0 != xdim0_write_kernel_h || ydim0 != ydim0_write_kernel_h || xdim1 != xdim1_write_kernel_h || ydim1 != ydim1_write_kernel_h || xdim2 != xdim2_write_kernel_h || ydim2 != ydim2_write_kernel_h || xdim3 != xdim3_write_kernel_h || ydim3 != ydim3_write_kernel_h || xdim4 != xdim4_write_kernel_h || ydim4 != ydim4_write_kernel_h || xdim5 != xdim5_write_kernel_h || ydim5 != ydim5_write_kernel_h || xdim6 != xdim6_write_kernel_h || ydim6 != ydim6_write_kernel_h) {
    ...
    xdim3_write_kernel = xdim3;
    xdim3_write_kernel_h = xdim3;
    ydim3_write_kernel = ydim3;
    ydim3_write_kernel_h = ydim3;
    xdim4_write_kernel = xdim4;
    xdim4_write_kernel_h = xdim4;
    ydim4_write_kernel = ydim4;
    ydim4_write_kernel_h = ydim4;
    xdim5_write_kernel = xdim5;
    xdim5_write_kernel_h = xdim5;
    ydim5_write_kernel = ydim5;
    ydim5_write_kernel_h = ydim5;
    xdim6_write_kernel = xdim6;
    xdim6_write_kernel_h = xdim6;
    ydim6_write_kernel = ydim6;
    ydim6_write_kernel_h = ydim6;
  }
