...
//
    ...
    void buildOpenCLKernels_write_kernel(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3, int xdim4, int ydim4, int xdim5, int ydim5, int xdim6, int ydim6) {
      ...
      if(!isbuilt_write_kernel) {
        ...
        instance->ostream() <<"Compiling write_kernel "<<OCL_FMA<<" source -- start \n";
          ...
          instance->ostream() << "compiling write_kernel -- done\n";

        // Create the OpenCL kernel
        instance->opencl_instance->OPS_opencl_core.kernel[0] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_write_kernel", &ret);
        clSafeCall( ret );
...
void ops_par_loop_write_kernel(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6, ops_arg arg7) {
  ...
  base0 = base0 + args[0].dat->size[0] *2*  args[0].dat->size[1] *2*
