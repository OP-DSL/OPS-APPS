...
int size, char *dat, char const *name){
  ...
  if (!strcmp(name,"yhalo")) {
    hipSafeCall(OPS_instance::getOPSInstance()->ostream(),hipMemcpyToSymbol(HIP_SYMBOL(yhalo_OPSCONSTANT), dat, dim*size));
  }
  else
  if (!strcmp(name,"xmin")) {
  ...
  if (!strcmp(name,"ymin")) {
    hipSafeCall(OPS_instance::getOPSInstance()->ostream(),hipMemcpyToSymbol(HIP_SYMBOL(ymin_OPSCONSTANT), dat, dim*size));
  }
  else
  if (!strcmp(name,"xmax")) {
  ...
  if (!strcmp(name,"ymax")) {
    hipSafeCall(OPS_instance::getOPSInstance()->ostream(),hipMemcpyToSymbol(HIP_SYMBOL(ymax_OPSCONSTANT), dat, dim*size));
  }
  else
  if (!strcmp(name,"dx")) {
...
//user kernel files
#include "initialize_kernel_hip_kernel.cpp"
#include "save_kernel_hip_kernel.cpp"
#include "zerores_kernel_hip_kernel.cpp"
#include "drhoudx_kernel_hip_kernel.cpp"
#include "drhouupdx_kernel_hip_kernel.cpp"
#include "drhoEpudx_kernel_hip_kernel.cpp"
...
#include "test_kernel_hip_kernel.cpp"
