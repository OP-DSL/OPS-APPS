...
//
    ...
    void buildOpenCLKernels_updateRK3_kernel(OPS_instance *instance, int xdim0, int xdim1, int xdim2, int xdim3, int xdim4, int xdim5, int xdim6, int xdim7, int xdim8) {
      ...
      if(!isbuilt_updateRK3_kernel) {
        ...
        instance->ostream() <<"Compiling updateRK3_kernel "<<OCL_FMA<<" source -- start \n";
          ...
          instance->ostream() << "compiling updateRK3_kernel -- done\n";

        // Create the OpenCL kernel
        instance->opencl_instance->OPS_opencl_core.kernel[6] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_updateRK3_kernel", &ret);
        clSafeCall( ret );
...
void ops_par_loop_updateRK3_kernel(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg9, ops_arg arg10) {
  ...
  buildOpenCLKernels_updateRK3_kernel(block->instance,
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[6], 9, sizeof(cl_double), (void*) arg9.data ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[6], 10, sizeof(cl_double), (void*) arg10.data ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[6], 11, sizeof(cl_double), (void*) &dt ));
