...
void ops_par_loop_updateRK3_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  #ifdef OPS_DEBUG
  ops_register_args(block->instance, args, "updateRK3_kernel");
  #endif
  ...
  double * __restrict__ rho_old_p = (double *)(args[3].data + base3);

  int base4 = args[4].dat->base_offset;
  double * __restrict__ rhou_old_p = (double *)(args[4].data + base4);

  int base5 = args[5].dat->base_offset;
  double * __restrict__ rhoE_old_p = (double *)(args[5].data + base5);

  int base6 = args[6].dat->base_offset;
  double * __restrict__ rho_res_p = (double *)(args[6].data + base6);

  int base7 = args[7].dat->base_offset;
  double * __restrict__ rhou_res_p = (double *)(args[7].data + base7);

  int base8 = args[8].dat->base_offset;
  double * __restrict__ rhoE_res_p = (double *)(args[8].data + base8);

  double * __restrict__ a1 = (double *)args[9].data;


  double * __restrict__ a2 = (double *)args[10].data;
  ...
  for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
    ...
    const ACC<double> rho_res(rho_res_p + n_x*1);
    const ACC<double> rhou_res(rhou_res_p + n_x*1);
    const ACC<double> rhoE_res(rhoE_res_p + n_x*1);
