...
extern int xdim1_Riemann_kernel;
int xdim1_Riemann_kernel_h = -1;
extern int xdim2_Riemann_kernel;
int xdim2_Riemann_kernel_h = -1;
extern int xdim3_Riemann_kernel;
int xdim3_Riemann_kernel_h = -1;
extern int xdim4_Riemann_kernel;
int xdim4_Riemann_kernel_h = -1;
extern int xdim5_Riemann_kernel;
...
void ops_par_loop_Riemann_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3, ops_arg arg4, ops_arg arg5) {
  ...
  if (xdim0 != xdim0_Riemann_kernel_h || xdim1 != xdim1_Riemann_kernel_h || xdim2 != xdim2_Riemann_kernel_h || xdim3 != xdim3_Riemann_kernel_h || xdim4 != xdim4_Riemann_kernel_h || xdim5 != xdim5_Riemann_kernel_h) {
    ...
    xdim1_Riemann_kernel = xdim1;
    xdim1_Riemann_kernel_h = xdim1;
    xdim2_Riemann_kernel = xdim2;
    xdim2_Riemann_kernel_h = xdim2;
    xdim3_Riemann_kernel = xdim3;
    xdim3_Riemann_kernel_h = xdim3;
    xdim4_Riemann_kernel = xdim4;
    xdim4_Riemann_kernel_h = xdim4;
    xdim5_Riemann_kernel = xdim5;
