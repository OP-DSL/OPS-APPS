...
extern int xdim0_zerores_kernel;
int xdim0_zerores_kernel_h = -1;
extern int xdim1_zerores_kernel;
int xdim1_zerores_kernel_h = -1;
extern int xdim2_zerores_kernel;
...
void ops_par_loop_zerores_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  if (xdim0 != xdim0_zerores_kernel_h || xdim1 != xdim1_zerores_kernel_h || xdim2 != xdim2_zerores_kernel_h) {
    xdim0_zerores_kernel = xdim0;
