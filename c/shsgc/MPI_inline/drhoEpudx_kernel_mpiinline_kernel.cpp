...
extern int xdim0_drhoEpudx_kernel;
int xdim0_drhoEpudx_kernel_h = -1;
extern int xdim1_drhoEpudx_kernel;
int xdim1_drhoEpudx_kernel_h = -1;
extern int xdim2_drhoEpudx_kernel;
int xdim2_drhoEpudx_kernel_h = -1;
extern int xdim3_drhoEpudx_kernel;
...
void ops_par_loop_drhoEpudx_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
  ...
  if (xdim0 != xdim0_drhoEpudx_kernel_h || xdim1 != xdim1_drhoEpudx_kernel_h || xdim2 != xdim2_drhoEpudx_kernel_h || xdim3 != xdim3_drhoEpudx_kernel_h) {
    xdim0_drhoEpudx_kernel = xdim0;
    xdim0_drhoEpudx_kernel_h = xdim0;
    xdim1_drhoEpudx_kernel = xdim1;
    xdim1_drhoEpudx_kernel_h = xdim1;
    xdim2_drhoEpudx_kernel = xdim2;
    xdim2_drhoEpudx_kernel_h = xdim2;
    xdim3_drhoEpudx_kernel = xdim3;
