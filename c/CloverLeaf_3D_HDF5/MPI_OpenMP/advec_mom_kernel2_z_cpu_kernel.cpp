  ...
  for ( int n_z=start[2]; n_z<end[2]; n_z++ ){
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        ACC<double> vel1(xdim0_advec_mom_kernel2_z, ydim0_advec_mom_kernel2_z, vel1_p + n_x*1 + n_y * xdim0_advec_mom_kernel2_z*1 + n_z * xdim0_advec_mom_kernel2_z * ydim0_advec_mom_kernel2_z*1);
        const ACC<double> node_mass_post(xdim1_advec_mom_kernel2_z, ydim1_advec_mom_kernel2_z, node_mass_post_p + n_x*1 + n_y * xdim1_advec_mom_kernel2_z*1 + n_z * xdim1_advec_mom_kernel2_z * ydim1_advec_mom_kernel2_z*1);
        const ACC<double> node_mass_pre(xdim2_advec_mom_kernel2_z, ydim2_advec_mom_kernel2_z, node_mass_pre_p + n_x*1 + n_y * xdim2_advec_mom_kernel2_z*1 + n_z * xdim2_advec_mom_kernel2_z * ydim2_advec_mom_kernel2_z*1);
        const ACC<double> mom_flux(xdim3_advec_mom_kernel2_z, ydim3_advec_mom_kernel2_z, mom_flux_p + n_x*1 + n_y * xdim3_advec_mom_kernel2_z*1 + n_z * xdim3_advec_mom_kernel2_z * ydim3_advec_mom_kernel2_z*1);
