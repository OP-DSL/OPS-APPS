...
//
    ...
    void buildOpenCLKernels_update_halo_kernel5_plus_4_b(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1) {
      ...
      if(!isbuilt_update_halo_kernel5_plus_4_b) {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[85] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_update_halo_kernel5_plus_4_b", &ret);
        clSafeCall( ret );
...
void ops_par_loop_update_halo_kernel5_plus_4_b(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,85,"update_halo_kernel5_plus_4_b");
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[85], 3, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[85], 4, sizeof(cl_int), (void*) &base1 ));
