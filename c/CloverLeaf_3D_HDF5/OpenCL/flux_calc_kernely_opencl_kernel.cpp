...
//
    ...
    void buildOpenCLKernels_flux_calc_kernely(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3) {
      ...
      if(!isbuilt_flux_calc_kernely) {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[106] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_flux_calc_kernely", &ret);
        clSafeCall( ret );
