...
//
    ...
    void buildOpenCLKernels_update_halo_kernel2_zvel_minus_4_back(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1) {
      ...
      if(!isbuilt_update_halo_kernel2_zvel_minus_4_back) {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[55] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_update_halo_kernel2_zvel_minus_4_back", &ret);
        clSafeCall( ret );
