...
//
    ...
    static bool isbuilt_advec_mom_kernel_z1 = false;

    void buildOpenCLKernels_advec_mom_kernel_z1(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3, int xdim4, int ydim4, int xdim5, int ydim5) {

      //int ocl_fma = OCL_FMA;
      if(!isbuilt_advec_mom_kernel_z1) {
        ...
        instance->ostream() <<"Compiling advec_mom_kernel_z1 "<<OCL_FMA<<" source -- start \n";
          ...
          instance->ostream() << "compiling advec_mom_kernel_z1 -- done\n";

        // Create the OpenCL kernel
        instance->opencl_instance->OPS_opencl_core.kernel[121] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_advec_mom_kernel_z1", &ret);
        clSafeCall( ret );

        isbuilt_advec_mom_kernel_z1 = true;
        free(source_str[0]);
      }
...
void ops_par_loop_advec_mom_kernel_z1(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,121,"advec_mom_kernel_z1");
  ...
  buildOpenCLKernels_advec_mom_kernel_z1(block->instance,
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[121], 2, sizeof(cl_mem), (void*) &arg2.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[121], 3, sizeof(cl_mem), (void*) &arg3.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[121], 4, sizeof(cl_mem), (void*) &arg4.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[121], 5, sizeof(cl_mem), (void*) &arg5.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[121], 6, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[121], 7, sizeof(cl_int), (void*) &base1 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[121], 8, sizeof(cl_int), (void*) &base2 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[121], 9, sizeof(cl_int), (void*) &base3 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[121], 10, sizeof(cl_int), (void*) &base4 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[121], 11, sizeof(cl_int), (void*) &base5 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[121], 12, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[121], 13, sizeof(cl_int), (void*) &y_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[121], 14, sizeof(cl_int), (void*) &z_size ));
  ...
  if (block->instance->OPS_diags > 1) {
    ...
    block->instance->OPS_kernels[121].transfer += ops_compute_transfer(dim, start, end, &arg1);
    block->instance->OPS_kernels[121].transfer += ops_compute_transfer(dim, start, end, &arg2);
    block->instance->OPS_kernels[121].transfer += ops_compute_transfer(dim, start, end, &arg3);
    block->instance->OPS_kernels[121].transfer += ops_compute_transfer(dim, start, end, &arg4);
    block->instance->OPS_kernels[121].transfer += ops_compute_transfer(dim, start, end, &arg5);
  }
}
