...
//
    ...
    void buildOpenCLKernels_update_halo_kernel2_zvel_plus_4_left(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1) {
      ...
      if(!isbuilt_update_halo_kernel2_zvel_plus_4_left) {
        ...
        instance->ostream() <<"Compiling update_halo_kernel2_zvel_plus_4_left "<<OCL_FMA<<" source -- start \n";
          ...
          instance->ostream() << "compiling update_halo_kernel2_zvel_plus_4_left -- done\n";

        // Create the OpenCL kernel
        instance->opencl_instance->OPS_opencl_core.kernel[51] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_update_halo_kernel2_zvel_plus_4_left", &ret);
        clSafeCall( ret );
...
void ops_par_loop_update_halo_kernel2_zvel_plus_4_left(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,51,"update_halo_kernel2_zvel_plus_4_left");
  ...
  buildOpenCLKernels_update_halo_kernel2_zvel_plus_4_left(block->instance,
