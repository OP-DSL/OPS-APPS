...
//
    ...
    void buildOpenCLKernels_revert_kernel(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3) {
      ...
      if(!isbuilt_revert_kernel) {
        ...
        instance->ostream() <<"Compiling revert_kernel "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              ...
              sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_revert_kernel=%d  -Dydim0_revert_kernel=%d  -Dxdim1_revert_kernel=%d  -Dydim1_revert_kernel=%d  -Dxdim2_revert_kernel=%d  -Dydim2_revert_kernel=%d  -Dxdim3_revert_kernel=%d  -Dydim3_revert_kernel=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1,xdim2,ydim2,xdim3,ydim3);
          else {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[103] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_revert_kernel", &ret);
        clSafeCall( ret );
...
void ops_par_loop_revert_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
  ...
  #ifdef CHECKPOINTING
  if (!ops_checkpointing_before(args,4,range,103)) return;
  #endif

  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,103,"revert_kernel");
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[103], 5, sizeof(cl_int), (void*) &base1 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[103], 6, sizeof(cl_int), (void*) &base2 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[103], 7, sizeof(cl_int), (void*) &base3 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[103], 8, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[103], 9, sizeof(cl_int), (void*) &y_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[103], 10, sizeof(cl_int), (void*) &z_size ));
