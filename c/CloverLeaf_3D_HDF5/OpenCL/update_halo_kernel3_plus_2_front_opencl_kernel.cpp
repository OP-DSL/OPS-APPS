...
//
    ...
    void buildOpenCLKernels_update_halo_kernel3_plus_2_front(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1) {
      ...
      if(!isbuilt_update_halo_kernel3_plus_2_front) {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[70] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_update_halo_kernel3_plus_2_front", &ret);
        clSafeCall( ret );
