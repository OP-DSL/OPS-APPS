...
//
    ...
    void buildOpenCLKernels_update_halo_kernel2_zvel_plus_4_top(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1) {
      ...
      if(!isbuilt_update_halo_kernel2_zvel_plus_4_top) {
        ...
        instance->ostream() <<"Compiling update_halo_kernel2_zvel_plus_4_top "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_update_halo_kernel2_zvel_plus_4_top=%d  -Dydim0_update_halo_kernel2_zvel_plus_4_top=%d  -Dxdim1_update_halo_kernel2_zvel_plus_4_top=%d  -Dydim1_update_halo_kernel2_zvel_plus_4_top=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1);
            else
              sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_update_halo_kernel2_zvel_plus_4_top=%d  -Dydim0_update_halo_kernel2_zvel_plus_4_top=%d  -Dxdim1_update_halo_kernel2_zvel_plus_4_top=%d  -Dydim1_update_halo_kernel2_zvel_plus_4_top=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1);
          else {
          ...
          instance->ostream() << "compiling update_halo_kernel2_zvel_plus_4_top -- done\n";

        // Create the OpenCL kernel
        instance->opencl_instance->OPS_opencl_core.kernel[49] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_update_halo_kernel2_zvel_plus_4_top", &ret);
        clSafeCall( ret );
...
void ops_par_loop_update_halo_kernel2_zvel_plus_4_top(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  buildOpenCLKernels_update_halo_kernel2_zvel_plus_4_top(block->instance,
