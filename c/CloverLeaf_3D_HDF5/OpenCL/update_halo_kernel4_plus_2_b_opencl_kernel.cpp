...
//
    ...
    void buildOpenCLKernels_update_halo_kernel4_plus_2_b(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1) {
      ...
      if(!isbuilt_update_halo_kernel4_plus_2_b) {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[78] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_update_halo_kernel4_plus_2_b", &ret);
        clSafeCall( ret );
