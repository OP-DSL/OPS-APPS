...
//
    ...
    void buildOpenCLKernels_update_halo_kernel1_b1(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3, int xdim4, int ydim4, int xdim5, int ydim5, int xdim6, int ydim6) {
      ...
      if(!isbuilt_update_halo_kernel1_b1) {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[12] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_update_halo_kernel1_b1", &ret);
        clSafeCall( ret );
