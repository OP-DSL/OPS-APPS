...
//
    ...
    void buildOpenCLKernels_ideal_gas_kernel(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3) {
      ...
      if(!isbuilt_ideal_gas_kernel) {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[10] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_ideal_gas_kernel", &ret);
        clSafeCall( ret );
...
void ops_par_loop_ideal_gas_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,10,"ideal_gas_kernel");
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[10], 10, sizeof(cl_int), (void*) &z_size ));
