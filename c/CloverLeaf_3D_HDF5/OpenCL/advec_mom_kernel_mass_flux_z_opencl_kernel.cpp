...
//
    ...
    static bool isbuilt_advec_mom_kernel_mass_flux_z = false;

    void buildOpenCLKernels_advec_mom_kernel_mass_flux_z(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1) {
      ...
      if(!isbuilt_advec_mom_kernel_mass_flux_z) {
        ...
        instance->ostream() <<"Compiling advec_mom_kernel_mass_flux_z "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_advec_mom_kernel_mass_flux_z=%d  -Dydim0_advec_mom_kernel_mass_flux_z=%d  -Dxdim1_advec_mom_kernel_mass_flux_z=%d  -Dydim1_advec_mom_kernel_mass_flux_z=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1);
            else
              sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_advec_mom_kernel_mass_flux_z=%d  -Dydim0_advec_mom_kernel_mass_flux_z=%d  -Dxdim1_advec_mom_kernel_mass_flux_z=%d  -Dydim1_advec_mom_kernel_mass_flux_z=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1);
          else {
          ...
          instance->ostream() << "compiling advec_mom_kernel_mass_flux_z -- done\n";

        // Create the OpenCL kernel
        instance->opencl_instance->OPS_opencl_core.kernel[134] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_advec_mom_kernel_mass_flux_z", &ret);
        clSafeCall( ret );
...
void ops_par_loop_advec_mom_kernel_mass_flux_z(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  buildOpenCLKernels_advec_mom_kernel_mass_flux_z(block->instance,
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[134], 2, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[134], 3, sizeof(cl_int), (void*) &base1 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[134], 4, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[134], 5, sizeof(cl_int), (void*) &y_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[134], 6, sizeof(cl_int), (void*) &z_size ));
