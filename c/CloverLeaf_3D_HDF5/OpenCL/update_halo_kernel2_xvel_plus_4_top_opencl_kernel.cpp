...
//
    ...
    void buildOpenCLKernels_update_halo_kernel2_xvel_plus_4_top(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1) {
      ...
      if(!isbuilt_update_halo_kernel2_xvel_plus_4_top) {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[25] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_update_halo_kernel2_xvel_plus_4_top", &ret);
        clSafeCall( ret );
