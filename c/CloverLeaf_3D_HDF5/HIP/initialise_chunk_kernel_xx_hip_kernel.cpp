...
int size2 ){
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ACC<int> argp0(dims_initialise_chunk_kernel_xx[0][0], dims_initialise_chunk_kernel_xx[0][1], arg0);
...
void ops_par_loop_initialise_chunk_kernel_xx_execute(ops_kernel_descriptor *desc) {
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    hipLaunchKernelGGL(ops_initialise_chunk_kernel_xx,grid ,tblock ,0 ,0 , (int *)p_a[0], arg_idx[0], arg_idx[1], arg_idx[2],x_size, y_size, z_size);
