...
int size2 ){
  ...
  for (int d=0; d<1; d++)
    ops_reduction_hip<OPS_INC>(&arg2[d+(hipBlockIdx_x + hipBlockIdx_y*hipGridDim_x + hipBlockIdx_z*hipGridDim_x*hipGridDim_y)*1],arg2_l[d]);
  for (int d=0; d<1; d++)
    ops_reduction_hip<OPS_INC>(&arg3[d+(hipBlockIdx_x + hipBlockIdx_y*hipGridDim_x + hipBlockIdx_z*hipGridDim_x*hipGridDim_y)*1],arg3_l[d]);
  for (int d=0; d<1; d++)
    ops_reduction_hip<OPS_INC>(&arg5[d+(hipBlockIdx_x + hipBlockIdx_y*hipGridDim_x + hipBlockIdx_z*hipGridDim_x*hipGridDim_y)*1],arg5_l[d]);
...
void ops_par_loop_calc_dt_kernel_get_execute(ops_kernel_descriptor *desc) {
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    hipLaunchKernelGGL(ops_calc_dt_kernel_get,grid ,tblock ,nshared ,0 , (double *)p_a[0], (double *)p_a[1],
