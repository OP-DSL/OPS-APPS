...
//
__constant__ int dims_update_halo_kernel1_ba1 [8][2];
static int dims_update_halo_kernel1_ba1_h [8][2] = {{0}};

//user function
__device__

inline void update_halo_kernel1_ba1_gpu(ACC<double> &density0,
  ACC<double> &density1,
  ACC<double> &energy0,
  ACC<double> &energy1,
  ACC<double> &pressure,
...
int size2 ){
  ...
  if (size0==-1) dims_update_halo_kernel1_ba1[0][0]=0;
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * dims_update_halo_kernel1_ba1[0][0] + idx_z * 1*1 * dims_update_halo_kernel1_ba1[0][0] * dims_update_halo_kernel1_ba1[0][1];
  arg1 += idx_x * 1*1 + idx_y * 1*1 * dims_update_halo_kernel1_ba1[1][0] + idx_z * 1*1 * dims_update_halo_kernel1_ba1[1][0] * dims_update_halo_kernel1_ba1[1][1];
  arg2 += idx_x * 1*1 + idx_y * 1*1 * dims_update_halo_kernel1_ba1[2][0] + idx_z * 1*1 * dims_update_halo_kernel1_ba1[2][0] * dims_update_halo_kernel1_ba1[2][1];
  arg3 += idx_x * 1*1 + idx_y * 1*1 * dims_update_halo_kernel1_ba1[3][0] + idx_z * 1*1 * dims_update_halo_kernel1_ba1[3][0] * dims_update_halo_kernel1_ba1[3][1];
  arg4 += idx_x * 1*1 + idx_y * 1*1 * dims_update_halo_kernel1_ba1[4][0] + idx_z * 1*1 * dims_update_halo_kernel1_ba1[4][0] * dims_update_halo_kernel1_ba1[4][1];
  arg5 += idx_x * 1*1 + idx_y * 1*1 * dims_update_halo_kernel1_ba1[5][0] + idx_z * 1*1 * dims_update_halo_kernel1_ba1[5][0] * dims_update_halo_kernel1_ba1[5][1];
  arg6 += idx_x * 1*1 + idx_y * 1*1 * dims_update_halo_kernel1_ba1[6][0] + idx_z * 1*1 * dims_update_halo_kernel1_ba1[6][0] * dims_update_halo_kernel1_ba1[6][1];

  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ACC<double> argp0(dims_update_halo_kernel1_ba1[0][0], dims_update_halo_kernel1_ba1[0][1], arg0);
    ACC<double> argp1(dims_update_halo_kernel1_ba1[1][0], dims_update_halo_kernel1_ba1[1][1], arg1);
    ACC<double> argp2(dims_update_halo_kernel1_ba1[2][0], dims_update_halo_kernel1_ba1[2][1], arg2);
    ACC<double> argp3(dims_update_halo_kernel1_ba1[3][0], dims_update_halo_kernel1_ba1[3][1], arg3);
    ACC<double> argp4(dims_update_halo_kernel1_ba1[4][0], dims_update_halo_kernel1_ba1[4][1], arg4);
    ACC<double> argp5(dims_update_halo_kernel1_ba1[5][0], dims_update_halo_kernel1_ba1[5][1], arg5);
    ACC<double> argp6(dims_update_halo_kernel1_ba1[6][0], dims_update_halo_kernel1_ba1[6][1], arg6);
    update_halo_kernel1_ba1_gpu(argp0, argp1, argp2, argp3,
...
void ops_par_loop_update_halo_kernel1_ba1_execute(ops_kernel_descriptor *desc) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,20,"update_halo_kernel1_ba1");
  ...
  if (xdim0 != dims_update_halo_kernel1_ba1_h[0][0] || ydim0 != dims_update_halo_kernel1_ba1_h[0][1] || xdim1 != dims_update_halo_kernel1_ba1_h[1][0] || ydim1 != dims_update_halo_kernel1_ba1_h[1][1] || xdim2 != dims_update_halo_kernel1_ba1_h[2][0] || ydim2 != dims_update_halo_kernel1_ba1_h[2][1] || xdim3 != dims_update_halo_kernel1_ba1_h[3][0] || ydim3 != dims_update_halo_kernel1_ba1_h[3][1] || xdim4 != dims_update_halo_kernel1_ba1_h[4][0] || ydim4 != dims_update_halo_kernel1_ba1_h[4][1] || xdim5 != dims_update_halo_kernel1_ba1_h[5][0] || ydim5 != dims_update_halo_kernel1_ba1_h[5][1] || xdim6 != dims_update_halo_kernel1_ba1_h[6][0] || ydim6 != dims_update_halo_kernel1_ba1_h[6][1]) {
    dims_update_halo_kernel1_ba1_h[0][0] = xdim0;
    dims_update_halo_kernel1_ba1_h[0][1] = ydim0;
    dims_update_halo_kernel1_ba1_h[1][0] = xdim1;
    dims_update_halo_kernel1_ba1_h[1][1] = ydim1;
    dims_update_halo_kernel1_ba1_h[2][0] = xdim2;
    dims_update_halo_kernel1_ba1_h[2][1] = ydim2;
    dims_update_halo_kernel1_ba1_h[3][0] = xdim3;
    dims_update_halo_kernel1_ba1_h[3][1] = ydim3;
    dims_update_halo_kernel1_ba1_h[4][0] = xdim4;
    dims_update_halo_kernel1_ba1_h[4][1] = ydim4;
    dims_update_halo_kernel1_ba1_h[5][0] = xdim5;
    dims_update_halo_kernel1_ba1_h[5][1] = ydim5;
    dims_update_halo_kernel1_ba1_h[6][0] = xdim6;
    dims_update_halo_kernel1_ba1_h[6][1] = ydim6;
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_update_halo_kernel1_ba1), dims_update_halo_kernel1_ba1_h, sizeof(dims_update_halo_kernel1_ba1)));
  }
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    hipLaunchKernelGGL(ops_update_halo_kernel1_ba1,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],
