...
void ops_par_loop_mblock_populate_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  #ifdef OPS_DEBUG
  ops_register_args(block->instance, args, "mblock_populate_kernel");
  #endif
  ...
  int xdim0_mblock_populate_kernel = args[0].dat->size[0];
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      ACC<double> val(xdim0_mblock_populate_kernel, val_p + n_x*1 + n_y * xdim0_mblock_populate_kernel*1);
