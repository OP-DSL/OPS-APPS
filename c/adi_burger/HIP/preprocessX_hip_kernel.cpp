...
//
__constant__ int dims_preprocessX [11][1];
static int dims_preprocessX_h [11][1] = {{0}};
...
int size1 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * dims_preprocessX[0][0];
  arg1 += idx_x * 1*1 + idx_y * 1*1 * dims_preprocessX[1][0];
  arg3 += idx_x * 1*1 + idx_y * 1*1 * dims_preprocessX[3][0];
  arg4 += idx_x * 1*1 + idx_y * 1*1 * dims_preprocessX[4][0];
  arg5 += idx_x * 1*1 + idx_y * 1*1 * dims_preprocessX[5][0];
  arg6 += idx_x * 1*1 + idx_y * 1*1 * dims_preprocessX[6][0];
  arg7 += idx_x * 1*1 + idx_y * 1*1 * dims_preprocessX[7][0];
  arg8 += idx_x * 1*1 + idx_y * 1*1 * dims_preprocessX[8][0];
  arg9 += idx_x * 1*1 + idx_y * 1*1 * dims_preprocessX[9][0];

  if (idx_x < size0 && idx_y < size1) {
    const ACC<double> argp0(dims_preprocessX[0][0], arg0);
    const ACC<double> argp1(dims_preprocessX[1][0], arg1);
    ACC<double> argp3(dims_preprocessX[3][0], arg3);
    ACC<double> argp4(dims_preprocessX[4][0], arg4);
    ACC<double> argp5(dims_preprocessX[5][0], arg5);
    ACC<double> argp6(dims_preprocessX[6][0], arg6);
    ACC<double> argp7(dims_preprocessX[7][0], arg7);
    ACC<double> argp8(dims_preprocessX[8][0], arg8);
    ACC<double> argp9(dims_preprocessX[9][0], arg9);
    preprocessX_gpu(argp0, argp1, &arg2, argp3,
...
void ops_par_loop_preprocessX_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_preprocessX_h[0][0] || xdim1 != dims_preprocessX_h[1][0] || xdim3 != dims_preprocessX_h[3][0] || xdim4 != dims_preprocessX_h[4][0] || xdim5 != dims_preprocessX_h[5][0] || xdim6 != dims_preprocessX_h[6][0] || xdim7 != dims_preprocessX_h[7][0] || xdim8 != dims_preprocessX_h[8][0] || xdim9 != dims_preprocessX_h[9][0]) {
    dims_preprocessX_h[0][0] = xdim0;
    dims_preprocessX_h[1][0] = xdim1;
    dims_preprocessX_h[3][0] = xdim3;
