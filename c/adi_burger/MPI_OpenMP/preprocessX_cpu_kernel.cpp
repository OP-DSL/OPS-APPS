...
void ops_par_loop_preprocessX_execute(ops_kernel_descriptor *desc) {
  ...
  int xdim3_preprocessX = args[3].dat->size[0];
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      const ACC<double> u(xdim0_preprocessX, u_p + n_x*1 + n_y * xdim0_preprocessX*1);
      const ACC<double> v(xdim1_preprocessX, v_p + n_x*1 + n_y * xdim1_preprocessX*1);
      ACC<double> a(xdim3_preprocessX, a_p + n_x*1 + n_y * xdim3_preprocessX*1);
      ACC<double> b(xdim4_preprocessX, b_p + n_x*1 + n_y * xdim4_preprocessX*1);
      ACC<double> c(xdim5_preprocessX, c_p + n_x*1 + n_y * xdim5_preprocessX*1);
      ACC<double> du(xdim6_preprocessX, du_p + n_x*1 + n_y * xdim6_preprocessX*1);
      ACC<double> dv(xdim7_preprocessX, dv_p + n_x*1 + n_y * xdim7_preprocessX*1);
      ACC<double> resU(xdim8_preprocessX, resU_p + n_x*1 + n_y * xdim8_preprocessX*1);
      ACC<double> resV(xdim9_preprocessX, resV_p + n_x*1 + n_y * xdim9_preprocessX*1);
