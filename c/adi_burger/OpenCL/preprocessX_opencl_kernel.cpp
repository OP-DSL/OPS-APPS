...
//
    ...
    void buildOpenCLKernels_preprocessX(OPS_instance *instance, int xdim0, int xdim1, int xdim3, int xdim4, int xdim5, int xdim6, int xdim7, int xdim8, int xdim9) {
      ...
      if(!isbuilt_preprocessX) {
        ...
        instance->ostream() <<"Compiling preprocessX "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_preprocessX=%d  -Dxdim1_preprocessX=%d  -Dxdim3_preprocessX=%d  -Dxdim4_preprocessX=%d  -Dxdim5_preprocessX=%d  -Dxdim6_preprocessX=%d  -Dxdim7_preprocessX=%d  -Dxdim8_preprocessX=%d  -Dxdim9_preprocessX=%d ", pPath, 32,xdim0,xdim1,xdim3,xdim4,xdim5,xdim6,xdim7,xdim8,xdim9);
            else
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[1] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_preprocessX", &ret);
        clSafeCall( ret );
...
void ops_par_loop_preprocessX(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg9, ops_arg arg10) {
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 2, sizeof(cl_double), (void*) arg2.data ));
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 10, sizeof(cl_int), (void*) &nx ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 11, sizeof(cl_int), (void*) &ny ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 12, sizeof(cl_double), (void*) &Re ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 13, sizeof(cl_double), (void*) &h ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 14, sizeof(cl_double), (void*) &r1 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 15, sizeof(cl_double), (void*) &r2 ));
