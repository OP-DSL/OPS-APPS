...
//
    ...
    void buildOpenCLKernels_preprocessY(OPS_instance *instance, int xdim0, int xdim1, int xdim3, int xdim4, int xdim5, int xdim6, int xdim7, int xdim8, int xdim9) {
      ...
      if(!isbuilt_preprocessY) {
        ...
        instance->ostream() <<"Compiling preprocessY "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_preprocessY=%d  -Dxdim1_preprocessY=%d  -Dxdim3_preprocessY=%d  -Dxdim4_preprocessY=%d  -Dxdim5_preprocessY=%d  -Dxdim6_preprocessY=%d  -Dxdim7_preprocessY=%d  -Dxdim8_preprocessY=%d  -Dxdim9_preprocessY=%d ", pPath, 32,xdim0,xdim1,xdim3,xdim4,xdim5,xdim6,xdim7,xdim8,xdim9);
            else
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[2] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_preprocessY", &ret);
        clSafeCall( ret );
...
void ops_par_loop_preprocessY(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg9, ops_arg arg10) {
  ...
  xdim0,xdim1,xdim3,xdim4,xdim5,xdim6,xdim7,xdim8,xdim9);
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[2], 2, sizeof(cl_double), (void*) arg2.data ));
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[2], 10, sizeof(cl_int), (void*) &nx ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[2], 11, sizeof(cl_int), (void*) &ny ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[2], 12, sizeof(cl_double), (void*) &Re ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[2], 13, sizeof(cl_double), (void*) &h ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[2], 14, sizeof(cl_double), (void*) &r1 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[2], 15, sizeof(cl_double), (void*) &r2 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[2], 16, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[2], 17, sizeof(cl_int), (void*) &base1 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[2], 18, sizeof(cl_int), (void*) &base3 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[2], 19, sizeof(cl_int), (void*) &base4 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[2], 20, sizeof(cl_int), (void*) &base5 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[2], 21, sizeof(cl_int), (void*) &base6 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[2], 22, sizeof(cl_int), (void*) &base7 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[2], 23, sizeof(cl_int), (void*) &base8 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[2], 24, sizeof(cl_int), (void*) &base9 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[2], 25, sizeof(cl_int), (void*) &arg_idx[0] ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[2], 26, sizeof(cl_int), (void*) &arg_idx[1] ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[2], 27, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[2], 28, sizeof(cl_int), (void*) &y_size ));
