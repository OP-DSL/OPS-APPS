    ...
    void buildOpenCLKernels_residue_eval(OPS_instance *instance, int xdim0, int xdim1, int xdim2, int xdim3, int xdim4, int xdim5) {
      ...
      if(!isbuilt_residue_eval) {
        ...
        instance->ostream() <<"Compiling residue_eval "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_residue_eval=%d  -Dxdim1_residue_eval=%d  -Dxdim2_residue_eval=%d  -Dxdim3_residue_eval=%d  -Dxdim4_residue_eval=%d  -Dxdim5_residue_eval=%d ", pPath, 32,xdim0,xdim1,xdim2,xdim3,xdim4,xdim5);
            else
              sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_residue_eval=%d  -Dxdim1_residue_eval=%d  -Dxdim2_residue_eval=%d  -Dxdim3_residue_eval=%d  -Dxdim4_residue_eval=%d  -Dxdim5_residue_eval=%d ", pPath, 32,xdim0,xdim1,xdim2,xdim3,xdim4,xdim5);
          else {
...
void ops_par_loop_residue_eval(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5) {
  ...
  buildOpenCLKernels_residue_eval(block->instance,
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[5], 10, sizeof(cl_int), (void*) &base4 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[5], 11, sizeof(cl_int), (void*) &base5 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[5], 12, sizeof(cl_int), (void*) &x_size ));
