...
//
    ...
    static bool isbuilt_calupwindeff_kernel = false;

    void buildOpenCLKernels_calupwindeff_kernel(OPS_instance *instance, int xdim0, int xdim1, int xdim2, int xdim3, int xdim4, int xdim5, int xdim6) {

      //int ocl_fma = OCL_FMA;
      if(!isbuilt_calupwindeff_kernel) {
        ...
        instance->ostream() <<"Compiling calupwindeff_kernel "<<OCL_FMA<<" source -- start \n";
          ...
          instance->ostream() << "compiling calupwindeff_kernel -- done\n";

        // Create the OpenCL kernel
        instance->opencl_instance->OPS_opencl_core.kernel[11] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_calupwindeff_kernel", &ret);
        clSafeCall( ret );

        isbuilt_calupwindeff_kernel = true;
        free(source_str[0]);
      }
...
void ops_par_loop_calupwindeff_kernel(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6) {
  ...
  buildOpenCLKernels_calupwindeff_kernel(block->instance,
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[11], 13, sizeof(cl_int), (void*) &base6 ));
