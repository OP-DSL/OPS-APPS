...
extern int xdim0_tvd_kernel;
int xdim0_tvd_kernel_h = -1;
extern int xdim1_tvd_kernel;
int xdim1_tvd_kernel_h = -1;
...
void ops_par_loop_tvd_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  if (xdim0 != xdim0_tvd_kernel_h || xdim1 != xdim1_tvd_kernel_h) {
    xdim0_tvd_kernel = xdim0;
    xdim0_tvd_kernel_h = xdim0;
