...
int size0 ){
  ...
  if (size0==-1) dims_init_kernel[0][0]=0;
...
void ops_par_loop_init_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_init_kernel_h[0][0] || xdim1 != dims_init_kernel_h[1][0] || xdim2 != dims_init_kernel_h[2][0] || xdim3 != dims_init_kernel_h[3][0] || xdim4 != dims_init_kernel_h[4][0] || xdim5 != dims_init_kernel_h[5][0] || xdim6 != dims_init_kernel_h[6][0] || xdim7 != dims_init_kernel_h[7][0]) {
    ...
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_init_kernel), dims_init_kernel_h, sizeof(dims_init_kernel)));
  }
  ...
  if (x_size > 0)
    hipLaunchKernelGGL(ops_init_kernel,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],
