...
extern int xdim0_calvar_kernel;
int xdim0_calvar_kernel_h = -1;
extern int xdim1_calvar_kernel;
int xdim1_calvar_kernel_h = -1;
extern int xdim2_calvar_kernel;
int xdim2_calvar_kernel_h = -1;
extern int xdim3_calvar_kernel;
int xdim3_calvar_kernel_h = -1;
extern int xdim4_calvar_kernel;
...
void ops_par_loop_calvar_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3, ops_arg arg4) {
  ...
  if (xdim0 != xdim0_calvar_kernel_h || xdim1 != xdim1_calvar_kernel_h || xdim2 != xdim2_calvar_kernel_h || xdim3 != xdim3_calvar_kernel_h || xdim4 != xdim4_calvar_kernel_h) {
    xdim0_calvar_kernel = xdim0;
    xdim0_calvar_kernel_h = xdim0;
    xdim1_calvar_kernel = xdim1;
    xdim1_calvar_kernel_h = xdim1;
    xdim2_calvar_kernel = xdim2;
    xdim2_calvar_kernel_h = xdim2;
    xdim3_calvar_kernel = xdim3;
    xdim3_calvar_kernel_h = xdim3;
    xdim4_calvar_kernel = xdim4;
